...
\hspace{21mm} \begin{tikzpicture}[overlay]
	\begin{axis}[clip=false, stack negative=separate, ymajorgrids=false,
            ...
            width=6.6cm, height=11.4cm, legend style={legend columns=1, at={(1.0, 1.16)}},
            \barylab{2.4cm}{1.2ex}]
	...
	\addplot[xbar stacked, bar shift=0pt, fill=blue!50!cyan, draw=cyan!60!blue!30!white] 
	...
	\legend{, 2000-- range, 2015-- range,, ,\input{text/jolts_ltdate.txt}}
	\end{axis}
\end{tikzpicture}
\vspace{1mm}
