...
%
	...
	\colorlet{navyblue}{blue!70!black}
	\colorlet{steelblue}{blue!60!black}
	\colorlet{tealgreen}{green!80!blue}
	\colorlet{forestgreen}{green!60!black}
	\colorlet{skyblue}{blue!50!cyan}
	\colorlet{lightcyan}{cyan!80!white}
	\colorlet{darkgray}{black!80!white}
	\colorlet{midgray}{black!40!white}
	\colorlet{paleblue}{cyan!60!white}
	\colorlet{darkred}{red!80!black}
	\colorlet{deepgreen}{green!85!black}
...
%
	...
	\pagestyle{fancy}
	\setlength{\headheight}{12.10004pt}
	\fancyhf{}
	...
	\newcommand{\tocentry}[2]{\item \seriffont {#2}
		 \  \  \  \  \  \footnotesize \hyperlink{#1}{\pageref*{#1}} \normalsize}
	...
	\pgfplotsset{compat=newest,
		...
		yticklabel style={text width=0.9em, align=right, inner sep=1.0pt},
	...
	\pgfplotsset{shortyear/.style={xticklabel={`\short{\year}}}}
	\pgfplotsset{dateaxis/.style={date coordinates in=x, axis line style={draw=none}}}
	...
	% stacked diverging bar (preloaded table)
	\newcommand{\sbarT}[4]{
		\addplot[ybar stacked, bar width=2.25pt, draw opacity=0, fill=#1]
			table [x=#2, y=#3]{#4};}
	...
	% custom width stacked diverging bar (preloaded table)
	\newcommand{\ctsbarT}[5]{
		\addplot[ybar stacked, bar width=#5, draw opacity=0, fill=#1]
			table [x=#2, y=#3]{#4};}
	...
	% area plot segment (preloaded table)
	\newcommand{\abarT}[4]{
		\addplot[stack plots=y, draw=none, fill=#1, legend image code/.code={
    \draw [#1] (0cm,-0.08cm) rectangle (0.2cm,0.12cm); }]
			table [x=#2, y=#3]{#4}\closedcycle;}
	...
	% Reserve vertical space for an overlay chart, given its pgfplots height
	\newcommand{\chartvspace}[1]{\vspace{\dimexpr #1 - 2.0cm\relax}}

	% Chart source attribution with optional data table link
	\newcommand{\chartsource}[2]{%
		\footnotesize{Source: #1}#2}

	% Table source attribution with standardized gap
	\newcommand{\tablesource}[2]{\vspace{-1.5mm}\footnotesize{Source: #1}#2}
	...
	\newcommand{\xmaxdate}{2026-03-31}
	\newcommand{\xmaxproj}{2029-03-31}

	% Date (X) Axis Tick Marks, every even year labeled, odd years minor
	...
	\pgfplotsset{ticks2yr/.style={xtick/.expanded={\aeticks}, minor xtick/.expanded={\aoticks}}}
	\pgfplotsset{ticks5yr/.style={xtick/.expanded={\afticks}, minor xtick/.expanded={\anfticks}}}

	% Date (X) Axis Tick Marks, every 5 years labeled, no minor ticks
	\newcommand{\shdateaxisticks}{
		dateaxis, xtick/.expanded={\afticks}, minor xtick={},
		xmax={\xmaxdate}, max space between ticks=40,
		enlarge y limits={0.06}, enlarge x limits={0.01},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		}

	% Date (X) Axis Tick Marks, yearly ticks from 2013
	...
	% Standard line (preloaded table)
	\newcommand{\stdlineT}[4]{\addplot[very thick, no markers, color=#1]
		table [x=#2, y=#3] {#4};	}
	...
	% Thicker line (preloaded table)
	\newcommand{\thicklineT}[4]{\addplot[ultra thick, no markers, color=#1]
		table [x=#2, y=#3] {#4};	}
