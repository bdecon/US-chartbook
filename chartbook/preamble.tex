...
%
	...
	\pgfplotsset{compat=newest,
		...
		yticklabel style={text width=1.6em, align=right, inner sep=1.0pt},
		clip=false,
	...
	\pgfplotsset{dateaxis/.style={date coordinates in=x, axis line style={draw=none}, enlarge x limits={0.01}}}
