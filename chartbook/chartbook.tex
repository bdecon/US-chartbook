...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2023-05-15},   
	...
	\newcommand{\tydateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmax={2023-05-15}, max space between ticks=40,	    
...
\footnotesize{\textit{millions of US dollars, seasonally adjusted \hspace{40mm} monthly average}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{1992-01-01}}{8.0}{\footnotesize \color{blue!60!black}\textbf{Effective}\\\footnotesize \color{blue!60!black}\textbf{Fed Funds Rate}}
...
\hspace*{-3mm} \begin{tikzpicture}
    \begin{groupplot}[group style={group size=2 by 1, horizontal sep=52pt,}]
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={-1, 0, 1, 2, 3}, ymin=-1.8, ymax=2.3,
    	yticklabel style={text width=1.2em}, 
