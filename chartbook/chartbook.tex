...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{2.3cm}{1.15cm}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
	\stdnode{1.6cm}{2.35cm}{\footnotesize \color{blue!40!cyan}Other}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.7cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{3.6cm}{0.78cm}{\footnotesize \color{green!90!blue}State}
	\end{axis}
\end{tikzpicture}\\
