...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[clip=false, stack negative=separate, ymajorgrids=false,
            ...
            width=5.9cm, height=12.9cm, legend style={at={(0.7, 1.05)}},
            \barylab{2.7cm}{1.5ex}]
	...
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Bureau of Labor Statistics} \hspace{23mm} \tbllink{quits_ind.csv}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Bureau of Labor Statistics} \hspace{24mm} \tbllink{openings_ind.csv}
\end{minipage}
