...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30, 40}, ymin=2,
		xticklabel={`\short{\year}}, clip=false, legend style={at={(0.95, 1.13)}}]
	\rbars
	\sbar{cyan!50!white}{date}{Consumer}{data/goodsimpsh.csv}	
	\sbar{blue!80!purple}{date}{Capital}{data/goodsimpsh.csv}	
	\sbar{red!80!purple}{date}{B648RC}{data/goodsimpsh.csv}	
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\thickline{red!80!purple}{date}{VALUE}{data/wti.csv}
	\end{axis}
\end{tikzpicture}\\
