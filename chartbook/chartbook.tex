...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={1.4, 1.5, 1.6, 1.7, 1.8, 1.9, 2.0, 2.1}, 
	...
	\stdnode{2.3cm}{1.3cm}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
	\stdnode{1.6cm}{2.5cm}{\footnotesize \color{blue!40!cyan}Other}
	\end{axis}
\end{tikzpicture}\\
