...
%
	...
	\newcommand{\rbars}{
		...
		\fill[color=black!10] (axis cs:{2020-02-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
			(axis cs:{2020-10-30}, \pgfkeysvalueof{/pgfplots/ymax});}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={40, 50, 60, 70}, 
		enlarge y limits={0.1}, 
		xticklabel={`\short{\year}}, height=5.2cm, width=7.4cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-30, -25, -20, -15, -10, -5, 0, 5, 10},
		height=6.0cm,  yticklabel style={text width=1.5em},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={49, 50, 51}, 
		...
		xticklabel={`\short{\year}}, height=5.8cm, width=6.8cm, clip=false]
	\rebars
...
\small \input{text/cps_educ2.txt} Some argue households compensated for a weak labor market and lack of bargaining power by borrowing large sums of money for education. Given the extent of the increase in education, and the typical wage premium of education, labor income should have increased substantially more than it actually did. 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20, 25}, ymin=1,
		xticklabel={`\short{\year}}, clip=false, height=6.0cm, width=7.0cm]
	\rbars
	\stdnode{4.2cm}{2.5cm}{\footnotesize \color{red}Goods}
	\stdline{red}{date}{Goods}{data/pce_levels.csv}
	\stdnode{2.8cm}{3.95cm}{\footnotesize \color{blue!75!white}Services ex. Housing}
...
\small Wealth-holding varies between households. Net worth, measured as total assets minus total liabilities, captures the overall financial position--or wealth--of households. In 2019, white non-Hispanic households average net worth was \$980,550, compared to \$142,330 for black non-Hispanic households, and \$165,540 for Hispanic households of any race. Additionally, the wealth of a typical (median) household is much lower than the wealth of the average (mean) household, the result of a concentration of wealth among the wealthiest households.
...
\normalsize \textbf{Poverty Measures, 2019}\\
\vspace{-6mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100, 125, 150},
		xticklabel={`\short{\year}}, clip=false, ymin=2, height=6.4cm,
...
\begin{minipage}{0.76\textwidth} 
\small The COVID-19 pandemic shifted the share of the US population that is employed in various occupational groups. Many workers lost or changed jobs and, additionally, some full-time workers became part-time and some part-time workers became full-time. The share of people employed full-time decreased in most occupational groups during the past three months, which end \input{text/cps_lfs_date.txt}\unskip, compared to the same three months one year prior.
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.86cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.96cm}{1.3cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[max space between ticks=38, height=6.8cm, width=8.0cm,	  
		axis line style={draw=none}, nodes near coords style={font=\scriptsize},
	...
	\addplot[ultra thick, mark=*, mark options={fill=white},
    	visualization depends on=\thisrow{alignment} \as \alignment, nodes near coords, 
    	every node near coord/.style={anchor=\alignment, /pgf/number format/fixed}, 
    		color=blue!60!black] 
...
\hspace*{-7mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{3.3cm}{1.5ex}
    	width=5.0cm, bar width=1.7ex, height=8.4cm,
