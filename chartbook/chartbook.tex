...
\hspace*{-2mm} \noindent \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.5pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.55}
		 \begin{tabular}{p{2mm} p{35.2mm} R{7.2mm} R{6.8mm} R{6.8mm} R{6.8mm} R{6.8mm} p{0mm} R{6.8mm} R{6.8mm} R{6.8mm} }
...
\noindent \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.1pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.52}
		 \begin{tabular}{p{41mm} R{7.6mm} R{6.7mm} R{6.7mm} R{6.7mm} R{6.7mm} 
		   R{7.8mm} R{6.7mm} R{6.7mm} }
			 \input{data/pi.tex}
			 \hline
		\end{tabular}
...
\hspace*{-2mm} \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.1pt} \color{black!90}
	{\renewcommand{\arraystretch}{1.55}
	\begin{tabular}{p{2.0mm} p{38mm} R{7.7mm} R{6.7mm} R{6.7mm} R{6.7mm} R{6.7mm} 
					R{7.8mm} R{6.7mm} R{6.7mm}}
		\input{data/pce.tex}
		\hline
	\end{tabular}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={70, 80}, width=12.2cm, clip=false,
		xticklabel={`\short{\year}}, yticklabel style={text width=1.5em}]
	\rbars
