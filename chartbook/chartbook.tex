...
\small Labor is the primary source of income for US households and is essential to the production of goods and services. The portion of labor that is provided by a household member to others outside of the household or to other households is called employment. \input{text/cps_lfs.txt}\\

When a member of a household is not employed but looked for a job during the past four weeks and is available to work, they are considered \href{https://www.bls.gov/cps/cps_htgm.htm}{unemployed}. \input{text/cps_lfs2.txt}\\
