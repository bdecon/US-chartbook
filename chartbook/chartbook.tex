...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2023-11-01},   
	...
	\newcommand{\tydateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmax={2023-11-01}, max space between ticks=40,	    
...
\textbf{Version 0.1 release planned for October 2023}
\end{minipage}
\newpage
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60, 70, 80}, 
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		yticklabel style={text width=1.0em},
		xticklabel={`\short{\year}}, clip=false, height=7.6cm, width=7.8cm]
	\rbars
	\absnode{{1992-01-01}}{49}{\footnotesize \color{blue!75!black}After-Tax \\ \color{blue!75!black} Income}
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60, 70, 80}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=7.6cm, width=7.8cm]
	\rbars
	\absnode{{2009-10-01}}{34}{\footnotesize \color{blue!50!cyan}After-Tax\\ \color{blue!50!cyan}Income}
	...
	\absnode{{1993-01-01}}{10}{\footnotesize \color{green!50!blue}Personal \\ \footnotesize \color{green!50!blue}Saving}
...
\hspace*{-1mm}\begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks legend cell align={left},
	yticklabel style={text width=1.4em}, xticklabel={`\short{\year}}, 
	clip=false, height=6.8cm, width=7.6cm,
	xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
	...
	\thinline{blue!80!black}{date}{Total index}{data/indpro.csv}
...
\noindent \hspace*{-5mm} \begin{tikzpicture} 
	...
	\rbar
	\node[right] at (axis description cs: 0.0,0.95) {\normalsize Market Group};
	\ctsbar{violet!70!purple!90!black}{date}{Consumer goods}{data/indprogr_rec.csv}{2.5pt} 
	\ctsbar{magenta}{date}{ENS}{data/indprogr_rec.csv}{2.5pt} 
	\ctsbar{orange!75!yellow}{date}{Non-energy materials}{data/indprogr_rec.csv}{2.5pt} 
	\ctsbar{blue!70!violet}{date}{Energy materials}{data/indprogr_rec.csv}{2.5pt} 
	\end{axis}
\end{tikzpicture} \hfill 
\begin{tikzpicture} \begin{axis}[\ltdateaxisticks 
	...
	\rbar
	\node[right] at (axis description cs: 0.0,0.95) {\normalsize Industry Group};
	\ctsbar{blue!62!black}{date}{Durable manufacturing}{data/indprogr_rec.csv}{2.5pt} 
	\ctsbar{blue!20!cyan!80!white}{date}{Nondurable manufacturing}{data/indprogr_rec.csv}{2.5pt} 
	\ctsbar{orange!30!yellow}{date}{Mining}{data/indprogr_rec.csv}{2.5pt} 
	\ctsbar{green!70!blue}{date}{Electric and gas utilities}{data/indprogr_rec.csv}{2.5pt}
	\end{axis} 
\end{tikzpicture}\\
...
\hspace{2.8cm} \begin{tikzpicture}[overlay]
  	\begin{axis}[\barplotnogrid axis y line=left, \bbar{x}{0}, \barylab{3.3cm}{1.6ex}
    	width=5.0cm, bar width=1.7ex, height=10.4cm,
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		width=12.6cm, height=5.8cm, clip=false, xticklabel={`\short{\year}}]
	\rbars
...
\end{minipage}
\newpage
\vspace*{-9mm} \hypertarget{govre}{\label{govre}}
...
\footnotesize{\textit{includes goods and services, but excludes petroleum products, share of GDP}}\vspace{3.45cm}

\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\dateaxisticks enlarge y limits={0.24},
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20,	 
		yticklabel style={text width=1.0em}, width=12.9cm,
