...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2023-02-15},   
...
\hspace*{-2mm} \begin{tikzpicture}[overlay]
  	\begin{axis}[ybar=12pt, \bbar{y}{0}, 
    	width=6.8cm, bar width=13pt, height=5.2cm, axis line style={draw=none}, 
    	x tick style={color=white}, ytick=false,
  		ymajorticks=false, 
    	enlarge y limits={value=0.18, upper}, enlarge x limits={abs=0.6cm}, 
		...
		legend style={at={(0.7, 1.10)}, legend columns=-1, 
