...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2022-10-15},   
	...
	\newcommand{\tydateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmax={2022-10-15}, max space between ticks=40,	    
...
The chartbook is a big menu of US economic and social indicators. While the chartbook aims for  superficial beautiful, it is unlikely that you, or anyone, will be completely satisfied with its contents. Instead, the contents, through combination with links and open-source code, are meant to inspire and enable your own examination of the indicators of interest or relevance.

Unfortunately, the draft chartbook contains many errors and is not particularly comprehensible without a background in economics and patience. I'm correcting the errors as I find them. I'm also in the gradual process of editing the text for clarity. 
...
GDP is produced by workers. The employment rate (see {\color{green!30!teal!90!black}\textbf{---}}) measures the share of the population that is employed. The rate nears 50 percent during the peak of economic expansions and falls during recessions. Over the past 30 years, the aging of the population has gradually reduced employment rates.

The amount people work is also influenced by economic conditions and affects output. Average hours worked per worker per week (see {\color{blue}\textbf{---}}) increase during an economic expansion, as more work is available. Average hours fall during a recession, when demand for goods and services is relatively low.
\end{minipage}
\vspace{2mm}
...
\small Production slowed across industry and market groups during the pandemic. Monthly data are shown below.
\vspace{1mm}
...
\noindent \hspace*{-5mm} \begin{tikzpicture} 
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks max space between ticks=20,
		clip=false, width=6.8cm, height=5.5cm, yticklabel style={text width=1.28em}, 
		yticklabel style={text width=1.5em}, xticklabel={`\short{\year}}, ymin=-18, ymax=18,
		minor xtick={}, enlarge y limits=0.02,  enlarge x limits={0.01}] 
	\rbar
	\ctsbar{violet!60!black}{date}{Consumer goods}{data/indprogr_rec.csv}{1.6pt} 
	\ctsbar{magenta}{date}{ENS}{data/indprogr_rec.csv}{1.6pt} 
	\ctsbar{orange!70!yellow}{date}{Materials}{data/indprogr_rec.csv}{1.6pt} 
	\end{axis}
\end{tikzpicture} \hfill 
\begin{tikzpicture} \begin{axis}[\ltdateaxisticks 
	clip=false, width=6.8cm, max space between ticks=20,	 
	height=5.5cm, yticklabel style={text width=1.28em}, 
	yticklabel style={text width=1.5em}, xticklabel={`\short{\year}}, ymin=-18, ymax=18,
	minor xtick={}, enlarge y limits=0.02,  enlarge x limits={0.01}] 
	\rbar
	\ctsbar{blue!60!black}{date}{Durable manufacturing}{data/indprogr_rec.csv}{1.6pt} 
	\ctsbar{blue!20!cyan!80!white}{date}{Nondurable manufacturing}{data/indprogr_rec.csv}{1.6pt} 
	\ctsbar{orange!20!yellow}{date}{Mining}{data/indprogr_rec.csv}{1.6pt} 
	\ctsbar{green!80!blue}{date}{Electric and gas utilities}{data/indprogr_rec.csv}{1.6pt}
	\end{axis} 
\end{tikzpicture}\\
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20}, 
		...
		xticklabel={`\short{\year}}, height=4.8cm, width=7.1cm, clip=false]
	\rbars
	...
	\absnode{{1995-01-01}}{14}{\footnotesize \color{blue}U6}
...
\hspace{7mm} \begin{tikzpicture}[overlay]
	...
	\absnode{{1991-06-01}}{1712}{\footnotesize \color{green!80!blue}Bachelor or \\\footnotesize \color{green!80!blue}Advanced\\\footnotesize \color{green!80!blue}Degree}
	\absnode{{2001-10-01}}{992}{\footnotesize \color{cyan}Some College}
	\absnode{{2012-02-01}}{1274}{\footnotesize \color{orange!80!yellow!85!red}Total,\\\footnotesize \color{orange!80!yellow!85!red}Any Education}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=7.0cm, width=7.0cm,	xmajorgrids, ymax=7.0, ymin=0.2,
