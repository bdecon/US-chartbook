...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={1000, 2000, 3000, 4000}, 
		enlarge y limits={0.1}, xmin = 1996-10-01,
		xticklabel={`\short{\year}}, height=5.0cm, width=7.6cm, clip=false]
	\rebars
	\stdline{green!80!blue}{date}{GSPC}{data/sp500.csv}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Yahoo! Finance} \hspace{30mm} \tbllink{sp500.csv} \\
