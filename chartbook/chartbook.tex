...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		yticklabel style={text width=1.4em}, height=5.4cm, max space between ticks=20, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		legend cell align=left,
		xticklabel={`\short{\year}}, clip=false, 
		legend style={at={(0.47, 0.91)}, legend columns=-1, fill=white}]
	\rbars
	...
	\node[below, align=left, shift=({rel axis cs:0.23,1.03}), fill=white]
		{\normalsize Gross Fixed Investment by Type};
	\end{axis}
\end{tikzpicture}
\vspace{3.1cm}
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		yticklabel style={text width=1.4em}, height=4.8cm, max space between ticks=20, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, clip=false]
	\rbars
	\sbar{red}{date}{A014RY}{data/inv.csv}
	\node[below, align=left, shift=({rel axis cs:0.21,1.0}), fill=white]
		{\normalsize Change in Private Inventories};
	\end{axis}
\end{tikzpicture}
...
\footnotesize{\textit{individual element effect on number of people in poverty, in millions of people, 2021}}\\
\vspace{0.5mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		width=6.9cm, height=5.8cm, clip=false, 
...
\hspace*{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\shdateaxisticks ytick={1.2, 1.3, 1.4, 1.5, 1.6, 1.7, 1.8}, 
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, width=7.4cm, ymax=1.68, enlarge y limits={0.1},
		height=6.4cm, clip=false]
	\rbars
...
\end{minipage}
\newpage
\begin{minipage}{0.3\textwidth} \index{industrial production} \index{industrial production!capacity utilization}
...
\hspace*{-4mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \bbar{x}{0}, \barylab{3.3cm}{1.5ex}
    	width=5.8cm, bar width=1.5ex, height=10.4cm,
    	enlarge y limits={abs=0.35cm}, enlarge x limits=0.02, 
		yticklabels from table={\ip}{name}, 
		yticklabel style={black!90, font=\scriptsize, text width=8em, xshift=-20pt}, 
		nodes near coords, 
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=1, assume math mode},
		legend style={text=black!70, at={(-0.1,1.05)}, anchor=north, legend columns=-1, 
				fill=none, draw=none,
		        /tikz/every even column/.append style={column sep=0.4cm}}]
...
\hspace*{-1mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		width=12.5cm, height=5.8cm, clip=false, xticklabel={`\short{\year}}]
	\rbars
...
\footnotesize{\textit{share of aggregate measure, percent \hspace{17mm} monthly per capita, \input{text/rs_dt.txt}\unskip \ dollars*}}
\vspace{3.0cm}

\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
		enlarge y limits={0.2}, yticklabel style={text width=1.0em}, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.1cm, width=5.8cm, clip=false]
	\rebars
	...
	\end{axis}
\end{tikzpicture} \hspace{6.3cm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ymin=140,
		enlarge y limits={0.08}, yticklabel style={text width=2.2em}, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
	...
	\absnode{{1993-01-01}}{890}{\scriptsize \color{green!80!olive}\textbf{Ex. Auto}\\\scriptsize \color{green!80!olive}\textbf{\& Gas}}
	\absnode{{2010-01-01}}{1960}{\scriptsize \color{violet!60!blue}\textbf{Total}}
	\absnode{{1992-01-01}}{325}{\scriptsize \color{black!70}*Adjusted by PCE price index}
	\end{axis}
\end{tikzpicture}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-20, -10, 0, 10, 20, 30, 40}, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, yticklabel style={text width=1.4em}, ymax=28.4,
		width=12.4cm, height=5.2cm, clip=false]
	\rebars
...
\end{minipage}
\newpage
\vspace*{-9mm} \hypertarget{govbs}{\label{govre}}
...
As discussed in the household section, Social Security is by far the main anti-poverty program in the US. \input{text/prog_sh.txt}
\end{minipage}
\vspace{1mm}
...
\hspace*{-2mm} \begin{tikzpicture}[overlay]
  	\begin{axis}[ybar=12pt, \bbar{y}{0}, 
		...
		legend style={at={(0.7, 1.1)}, legend columns=-1, 
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20,
		yticklabel style={text width=1.0em}, xticklabel={`\short{\year}}, 
		clip=false, height=6.0cm, width=12.5cm, enlarge y limits=0.12,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		legend columns=1, legend cell align={left}, reverse legend,
		legend style={at={(0.43, 1.0)}}]
	\rbars
...
\footnotesize{\textit{not in the labor force due to disability/illness, age 25 to 54}}\\
\footnotesize{\textit{share employed one year later, percent, one-year moving average}}\\
\hspace*{-1mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks clip=false, ymin=0.5, ymax=10.2,
		yticklabel style={text width=1.0em}, max space between ticks=30,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=6.0cm, width=8.6cm]
	\rebars
...
\hspace*{-1mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks tick label style={inner sep=0pt},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks clip=false, 
		enlarge y limits={0.22}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=4.8cm, width=7.2cm]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false, max space between ticks=15, 
		enlarge y limits={0.28}, tick label style={inner sep=0pt},
	...
	\absnode{{2011-01-01}}{3.9}{\footnotesize \color{orange!80!yellow}\textbf{20Y Avg.}}
	\absnode{{1993-01-01}}{5.8}{\footnotesize \color{blue!80!black}\textbf{1Y Avg.}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ymax=12,
...
\hspace*{-1mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 5, 10, 15, 20}, ymin=1,
		height=5.0cm, width=12.5cm, enlarge y limits={0.09},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		yticklabel style={text width=1.0em}, 
		xticklabel={`\short{\year}}, clip=false]
	\rbars
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks  ytick={-6, -4, -2, 0, 2, 4, 6, 8},
		yticklabel style={text width=1.4em}, enlarge y limits={0.08}, ymax=5.7,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20, 25},
		enlarge y limits={0.16}, 
		yticklabel style={text width=1.2em}, width=7.2cm, height=5.4cm,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
