...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\rbars
	\ctsbar{blue!75!cyan}{date}{core_goods}{data/cpi_decomp.csv}{2pt}
	\ctsbar{green!80!yellow!80!black}{date}{core_services}{data/cpi_decomp.csv}{2pt}
	\ctsbar{yellow!80!orange}{date}{shelter}{data/cpi_decomp.csv}{2pt}
	\ctsbar{red}{date}{food_energy}{data/cpi_decomp.csv}{2pt}
