...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2022-10-31},   
...
%
\textbf{Version 0.1 release planned for Winter 2022}
\end{minipage}
\newpage
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{0.95cm}{2.7cm}{\footnotesize \color{blue!90!white}Other Services}
	\stdline{blue!90!white}{date}{Oth_Serv}{data/gdpva_pc.csv}
	\stdnode{1.6cm}{1.86cm}{\footnotesize \color{red!90!white}FIRE+}
	\stdline{red!90!white}{date}{FIRE}{data/gdpva_pc.csv}
	\stdnode{3.1cm}{4.25cm}{\footnotesize \color{purple!70!blue}Goods + TTU}
...
\footnotesize{\textit{annual growth, percent \hspace{52mm} recent quarterly \hspace{11mm} nowcast}}\\
\hspace*{-2.5mm} 
\begin{tikzpicture}
    \begin{groupplot}[group style={group size=2 by 1, 
    y descriptions at=edge left, horizontal sep=12pt,},]
    \nextgroupplot[\bbar{y}{0}, \shdateaxisticks 
		yticklabel style={text width=1.0em}, ymin=-4.0, ymax=7.5,
		ytick={-4, -2, 0, 2, 4, 6, 8},
	...
	\draw [dashed] (axis cs:{2022-05-15},\pgfkeysvalueof{/pgfplots/ymin}) -- 
		(axis cs:{2022-05-15}, \pgfkeysvalueof{/pgfplots/ymax});
	\end{groupplot}
\end{tikzpicture}\\
...
The Federal Reserve Bank of Atlanta uses available economic indicators to \textbf{nowcast} the current growth rate. \input{text/gdpnow.txt}(see \tikz \draw[blue!70!green, fill=cyan] (2.5pt,2.5pt) circle (2.5pt);).
\end{minipage}
\newpage
\begin{minipage}{0.76\textwidth}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	...
	\rbars
	\absnode{{1992-01-01}}{42}{\footnotesize \color{blue!75!black}Income}
	\stdline{blue!75!black}{date}{DPI}{data/inc_out_save.csv}
	\absnode{{2011-01-01}}{42}{\footnotesize \color{orange}Spending}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	...
	\absnode{{2010-01-01}}{18}{\footnotesize \color{red!50!orange}Spending}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdline{red}{date}{Goods}{data/pce_levels.csv}
	\absnode{{1998-07-01}}{25}{\footnotesize \color{blue!75!white}Services ex. Shelter}
	\stdline{blue!75!white}{date}{OTHSERV}{data/pce_levels.csv}
	\absnode{{1993-06-01}}{13.8}{\footnotesize \color{green!85!blue}Shelter}
...
\newpage 
\begin{minipage}{0.76\textwidth}
\small Next, we examine the affect on GDP growth from changes in consumer spending on goods (see\cbox{red}), services excluding housing and utilities (see\cbox{blue!75!white}), and shelter (see\cbox{green!85!blue}, calculated as housing and utilities plus residential fixed investment). \input{text/pce1.txt}
\vspace{1mm}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10, 15, 20},
		...
		legend style={at={(0.55, 0.24)}, fill=white, legend columns=2}]
	\rbars
...
\end{tikzpicture} \hfill \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ymin=180,
	...
	\absnode{{1993-01-01}}{840}{\scriptsize \color{green!80!olive}\textbf{Ex. Auto}\\\scriptsize \color{green!80!olive}\textbf{\& Gas}}
	\absnode{{2010-01-01}}{1880}{\scriptsize \color{violet!60!blue}\textbf{Total}}
...
\hspace*{-2mm} \begin{tikzpicture} 
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks xmin={2016-01-01}, 
		enlarge y limits={0.14}, max space between ticks=20,
		yticklabel style={text width=1.4em}, 
		clip=false, xticklabel={`\short{\year}}, height=6.2cm, width=6.4cm]
	\rbar
	...
	\absnode{{2017-07-01}}{1.58}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20,	 
		...
		xticklabel={`\short{\year}}, clip=false, 
		legend style={at={(0.91, 0.98)}, fill=white}]
	\rbars
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
		...
		yticklabel style={text width=1.5em}, width=6.0cm, height=6.0cm,
...
\hspace*{-2mm} \begin{tikzpicture}[overlay]
  	\begin{axis}[ybar=12pt, \bbar{y}{0}, 
    	width=6.8cm, bar width=13pt, height=5.1cm, axis line style={draw=none}, 
    	x tick style={color=white}, ytick=false,
  		ymajorticks=false, 
    	enlarge y limits={value=0.25, upper}, enlarge x limits={abs=0.6cm}, 
    	xtick=data,	xticklabels from table={\emplt}{label},
		xticklabel style={black!75, font=\footnotesize, text width=1.1cm, align=center}, 
		clip=false, nodes near coords,  
		nodes near coords style={/pgf/number format/.cd, 
			precision=0, assume math mode}, legend cell align={left},
		legend style={at={(0.7, 1.12)}, legend columns=-1, 
...
\hspace*{-2mm} \begin{tikzpicture}
    ...
    \rbar
	\ctsbar{blue!60!purple}{date}{ALL}{data/nfp.csv}{3.2pt}
...
\footnotesize{\textit{employed share of age 25 to 54 population, percent, not seasonally adjusted}}\\
\vspace{-3mm}
...
\hspace*{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 5, 10, 15, 20}, 
		enlarge y limits={0.1}, yticklabel style={text width=1.0em},
		xticklabel={`\short{\year}}, clip=false, height=5.0cm, ymin=1.4, ymax=17,
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{3.65cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
	\stdnode{2.7cm}{0.7cm}{\footnotesize \color{cyan!80!blue}State}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.7cm}{4.0cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
	\stdnode{2.6cm}{0.85cm}{\footnotesize \color{green!90!blue}State}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\absnode{{2013-06-01}}{0.32}{\footnotesize \color{red}\textbf{Family/Care}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks  \bbar{y}{0}, 
		...
		yticklabel style={text width=1.2em}, ymin=1, ymax=28,
	...
	\absnode{{2013-10-01}}{25.3}{\footnotesize \color{violet!50!blue}\textbf{Voluntary}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false,
		...
		xticklabel={`\short{\year}}, height=4.4cm, width=7.0cm]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60}, ymin=3,
		xticklabel={`\short{\year}}, clip=false, yticklabel style={text width=1.4em}, 
...
In March 2022, the FOMC raised the base interest rate by 25 basis points. In May 2022, the FOMC raised the base interest rate by another 25 basis points. In June, July, and September 2022, the FOMC raised rates by 75 basis points, in each meeting. \input{text/rates_ff.txt}
\vspace{2mm}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=7.0cm, width=7.0cm,	xmajorgrids, ymax=7.4, ymin=0.2,
...
\hspace*{-3mm} \begin{tikzpicture}
    \begin{groupplot}[group style={group size=2 by 1, horizontal sep=52pt,}]
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={0, 1, 2, 3}, ymin=-0.65, ymax=2.3,
    	yticklabel style={text width=0.8em},
     xticklabel={\year}, height=5.6cm, width=5.9cm, clip=false]
    \rbar
...
A large increase in the amount of money held by individuals and institutions can be the result of a higher rate of saving, a larger government sector financial deficit, an increase in the money supply, a change in preferences for liquidity, or something else. \input{text/m2chg.txt}
\vspace{2mm}
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, date coordinates in=x, axis line style={draw=none},
		enlarge y limits={0.06}, enlarge x limits={0.02}, width=13.0cm, height=5.0cm,
		yticklabel style={text width=1.0em}, ymax=14.8, ymin=-3.6, clip=false,
		nodes near coords,
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
	...
	\node[below right, align=left] at (rel axis cs:0.365, 1.16) {\color{black!40!white}\footnotesize {latest 12 months}};
	\end{axis}
\end{tikzpicture}\\
