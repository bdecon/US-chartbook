...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{2.0cm}{1.45cm}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
	\stdnode{1.4cm}{2.95cm}{\footnotesize \color{blue!40!cyan}Other}
	\end{axis}
\end{tikzpicture}\\
