...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={1.4, 1.5, 1.6, 1.7, 1.8, 1.9}, 
	...
	\stdnode{1.4cm}{1.2cm}{\footnotesize \color{blue!70!black}Individual Income Taxes}
	\stdnode{1.4cm}{3.4cm}{\footnotesize \color{blue!40!cyan}Other}
	\end{axis}
\end{tikzpicture}\\
