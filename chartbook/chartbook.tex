...
Unless otherwise noted: charts and data are adjusted for inflation and seasonality; growth and interest rates are presented on an annualized basis; and average growth rates are simple averages and do not account for compounding. 
\end{minipage}
\thispagestyle{empty}
