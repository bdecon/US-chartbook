...
\input{text/cps_lfs.txt} Note that these values are not seasonally adjusted and include individuals under age 16, while published values are typically refer to those 16 or older.
\end{minipage} \hspace{6mm}
