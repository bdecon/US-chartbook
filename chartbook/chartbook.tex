...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\draw [dashed] (axis cs:{2002-01-01},\pgfkeysvalueof{/pgfplots/ymin}) -- (axis cs:{2002-01-01},
		\pgfkeysvalueof{/pgfplots/ymax});
	\stdnode{3.8cm}{3.3cm}{\scriptsize historical}
	\stdnode{5.0cm}{3.3cm}{\scriptsize revised}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{2.9cm}{2.3cm}{\footnotesize \color{green!80!blue}Exports}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.6cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.5cm}{3.8cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
	\stdnode{3.55cm}{0.8cm}{\footnotesize \color{green!90!blue}State}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{8.5cm}{3.4cm}{\footnotesize \color{blue!80!black}\textbf{Openings}}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{3.8cm}{3.28cm}{\scriptsize \color{red!50!purple}\textbf{Accommodations}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{8.4cm}{1.65cm}{\scriptsize \color{cyan!50!white}\textbf{Modified Taylor Rule}}
	\end{axis}
\end{tikzpicture}\\
