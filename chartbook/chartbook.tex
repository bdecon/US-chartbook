...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2023-10-01},   
	...
	\newcommand{\tydateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmax={2023-10-01}, max space between ticks=40,	    
...
\hspace*{-3mm}\begin{minipage}{0.48\textwidth}
\setlength{\parskip}{5pt}
\begin{description}
\tocentry{oea}{Overall Economic Activity}
\begin{description}
\tocentry{oety}{Types of Activity}
\tocentry{oegr}{Economic Growth}
\tocentry{oegc}{Components of Growth}
\end{description}
\tocentry{ofa}{Overall Financial Activity}
\begin{description}
\tocentry{ofl}{Liabilities}
\tocentry{ofsb}{Sectoral Balances}
\tocentry{ofw}{Wealth}
\tocentry{ofi}{Investment}
\end{description}
\tocentry{hh}{Households}
\begin{description}
\tocentry{hhdem}{Demographics}
\tocentry{hhinc}{Income}
\tocentry{hhss}{Spending and Saving}
\tocentry{hhbs}{Balance Sheets}
\tocentry{hhh}{Housing}
\tocentry{hhpov}{Poverty}
\end{description}
\tocentry{bus}{Businesses}
\begin{description}
\tocentry{busin}{Investment}
\tocentry{buspr}{Corporate Profits}
\item {Balance Sheets}
\tocentry{busip}{Industrial Production}
\tocentry{busrs}{Retail Sales}
\end{description}
\tocentry{gov}{Government}
\begin{description}
\item Spending and Investment
\item Revenue
\tocentry{govbs}{Balance Sheets}
\end{description}
\tocentry{ext}{External Sector}
\begin{description}
\tocentry{exbop}{Balance of Payments}
\tocentry{extt}{International Trade}
\tocentry{exiip}{International Investment Position}
\tocentry{excf}{Capital Flows}
\tocentry{extfx}{Exchange Rates}
\end{description}
\end{description}
...
\begin{description}
\tocentry{labe}{Employment}
\tocentry{labu}{Unemployment}
\tocentry{labp}{Participation}
\tocentry{labf}{Labor Force Flows}
\tocentry{labh}{Hours}
\tocentry{labns}{Nonstandard Work Arrangements}
\tocentry{labw}{Wages}
\tocentry{labprod}{Productivity}
\tocentry{labun}{Union Membership}
\end{description}
\tocentry{cap}{Capital Markets}
\begin{description}
\tocentry{capeq}{Equity Markets}
\tocentry{capint}{Interest Rates}
\tocentry{capmm}{Money and Monetary Policy}
\end{description}
\tocentry{pr}{Prices}
\begin{description}
\tocentry{prin}{Consumer Price Index}
\tocentry{prie}{Inflation Expectations}
\tocentry{prpce}{PCE Price Index}
\tocentry{prp}{Producer Prices}
\tocentry{prex}{Import and Export Prices}
\tocentry{prco}{Commodities}
\end{description}
\tocentry{index}{Index}
\end{description}
\vspace{6cm}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={200, 220, 240, 260, 280, 300, 320, 340}, 
		...
		xticklabel={`\short{\year}}, height=4.9cm, width=6.1cm, clip=false]
	\rbars
...
\begin{minipage}{0.47\textwidth} \index{liabilities!by sector}
...
\end{minipage}
\hfill
\begin{minipage}{0.47\textwidth} \index{debt!by sector}
...
\begin{minipage}{0.76\textwidth}
\subsection*{Investment} \index{investment!overview} \index{investment!fixed investment} \index{investment!construction spending}
...
\end{minipage}
\newpage
\index{investment!fixed investment} \index{investment!inventory investment} \index{inventories}
\begin{minipage}{0.76\textwidth}
...
\begin{minipage}{0.76\textwidth} \index{investment!net fixed investment}
...
\end{minipage}
\newpage
\begin{minipage}{0.76\textwidth} \index{households!household formation} \index{housing!homeownership} \index{housing!vacancies}
...
The Consumer Expenditure Surveys \href{https://www.bls.gov/cex/tables.htm}{provide} data on typical income, spending, and saving, measured as the median rather than the average. Median income, spending, and saving are not affected by the activities of the highest income families, which skew mean or average data. Saving is calculated as after-tax income minus spending, excluding spending on pensions (which count as saving). \input{text/ce_med_inc.txt}
\end{minipage}
\vspace{2mm}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60, 70, 80}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=7.9cm, width=7.8cm]
	\rbars
	...
	\absnode{{2012-04-01}}{44.5}{\footnotesize \color{orange}Spending}
	\stdline{orange}{date}{PCE}{data/inc_out_save.csv}
	\absnode{{2013-07-01}}{10}{\footnotesize \color{green!80!blue}Saving}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	...
	\absnode{{2010-01-01}}{19}{\footnotesize \color{red!50!orange}Spending}
	\thickline{red!50!orange}{date}{ADJEXP_4}{data/medincexp.csv}
	\absnode{{2012-10-01}}{8}{\footnotesize \color{green!50!blue}Saving}
...
\end{minipage}
\newpage
\subsection*{Income to Persons} \index{income!personal}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdline{red}{date}{Goods}{data/pce_levels.csv}
	\absnode{{1997-10-01}}{26}{\footnotesize \color{blue!75!white}Services ex. Shelter}
...
\hspace*{-2mm} \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.6pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.55}
		 \begin{tabular}{p{40mm} R{11mm} R{10mm} R{10mm} R{10mm} R{10mm} R{10mm}}
...
\hypertarget{hhbs}{\label{hhbs}} \index{debt!household} \index{balance sheet!household} \index{households!balance sheets} \index{consumer credit}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100, 125, 150},
		ymin=3,tick label style={inner sep=0pt},
		yticklabel style={text width=1.5em}, width=12.4cm,
	...
	\node[right] at (axis description cs: -0.05,0.98) [fill=white, inner sep=0.4]{\footnotesize{\textit{share of disposable personal income, percent}}};
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\barplotnogrid \barylab{1.9cm}{1.5ex}
		...
		\addplot [draw=none, fill=gray,discard if not={color}{gray}] 
			table [y expr=\coordindex,x index=2,col sep=comma]
				{data/ccdebtbar.csv};
		\addplot [draw=none,fill=blue!60!cyan,
			discard if not={color}{blue!60!cyan}] 
			table [y expr=\coordindex, x index=2,col sep=comma]
				{data/ccdebtbar.csv};
		\addplot [draw=none,fill=red,discard if not={color}{red}] 
			table [y expr=\coordindex, x index=2,col sep=comma]
				{data/ccdebtbar.csv};
		\addplot [draw=none,fill=green!80!blue,
			discard if not={color}{green!80!blue}] 
			table [y expr=\coordindex, x index=2,col sep=comma]
				{data/ccdebtbar.csv};
	\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	\absnode{{2002-08-01}}{5.8}{\scriptsize \color{green!80!blue}{Student}}
...
\small Trends in \textbf{household debt} over the past four years, measured in both the US Financial Accounts and the New York Fed Consumer Credit Panel, show mortgage debt increasing as a share of income while consumer credit comprises roughly the same share of income. 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false, xmin={1989-08-01},
		tick label style={inner sep=0pt},yticklabel style={text width=1.0em},
		ymin=0.6, xticklabel={`\short{\year}}, height=7.0cm, width=6.4cm]
	\rbars
...
\end{minipage}\hspace{7mm}
\begin{minipage}{0.41\textwidth} \index{housing!owner's equity}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 200, 400, 600, 800, 1000}, 
		yticklabel style={text width=1.8em}, legend style={at={(0.48, 1.0)}}, ymin=32, reverse legend,
...
\begin{minipage}{0.575\textwidth} \index{housing!affordability}
...
\footnotesize{\textit{millions of people}}\\
  \hspace*{-3mm} \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[lime!70!green!90!blue] coordinates {(25.5, 1)};
      \addplot[blue] coordinates {(78.2, 2)};
    \end{axis}
  \end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[ymin=0, ymax=15, enlarge x limits={0.01},
		width=6.7cm, height=5.9cm, ytick={0, 5, 10, 15}, 
...
\hspace*{-1mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
		...
		xticklabel={`\short{\year}}, clip=false, ymin=6.1, ymax=17.9, 
		enlarge y limits={0.01}, tick label style={inner sep=0pt},
		height=5.6cm, width=7.1cm,  yticklabel style={text width=1.0em}]
	\rbars
	\thickline{green!60!blue}{date}{OPM_LT}{data/poverty_opm_line.csv}
	\thickline{green!60!blue}{date}{OPM_PR2}{data/poverty_opm_line.csv}
	\thickline{lime!70!green!90!blue}{date}{LT}{data/poverty_spm_line.csv}
	\thickline{lime!70!green!90!blue}{date}{PR}{data/poverty_spm_line.csv}
	\thickline{lime!70!green!90!blue}{date}{PR2}{data/poverty_spm_line.csv}
	\thickline{lime!70!green!90!blue}{date}{PR3}{data/poverty_spm_line.csv}
	\thickline{lime!70!green!90!blue}{date}{PR4}{data/poverty_spm_line.csv}
	\absnode{{2009-10-01}}{17.5}{\footnotesize \color{lime!70!green!90!blue}\textbf{Supplemental} \\  \ \ \ \ \ \ \ \ \ \ \ \ \color{lime!70!green!90!blue}\textbf{(SPM)}}
	\absnode{{1993-01-01}}{12.1}{\footnotesize \color{green!60!blue}\textbf{Official} \\ \small \color{green!60!blue}\textbf{(OPM)}}
...
\newpage
\begin{minipage}{0.76\textwidth}
\subsection*{Business Assets} \index{assets!business} \index{businesses!assets}
...
\end{minipage}
\newpage
\begin{minipage}{0.32\textwidth} \index{industrial production}
...
\end{minipage}
\newpage
\subsubsection*{Energy Production and Use} \vspace{-1mm}
...
\begin{minipage}{0.6\textwidth} \index{electricity production}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20},
		...
		xticklabel={`\short{\year}}, clip=false, height=5.6cm, width=7.0cm]
	\rbars
	\stdnode{4.2cm}{3.1cm}{\footnotesize \color{violet}Welfare}
...
\hspace*{-2mm} \begin{tikzpicture} 
	...
	\absnode{{2020-02-01}}{2.6}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
	\absnode{{2016-06-01}}{1.85}{\footnotesize \color{blue!40!cyan}Other}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\ctsbar{yellow!60!lime!85!white}{date}{GOODS}{data/cab.csv}{2.3pt}
	\ctsbar{cyan!50!white}{date}{SERVICES}{data/cab.csv}{2.3pt}
	\ctsbar{blue!80!cyan}{date}{INCOME}{data/cab.csv}{2.3pt}
	\ctsbar{green!80!blue}{date}{TRANSFERS}{data/cab.csv}{2.3pt}
...
\hspace*{-4mm} \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{2.6pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.6}
...
\index{exchange rates} \index{US dollar} \index {Canadian dollar} \index{Japanese yen} \index{British pounds} \index{euros}
...
\end{minipage}
\newpage
\begin{minipage}{0.76\textwidth} \index{exchange rates} \index{US dollar}
...
\end{minipage}
\newpage
\begin{minipage}{0.76\textwidth} \index{income, gross labor income} \index{compensation of employees}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false, enlarge y limits={0.24}, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={20, 25, 30, 35, 40}, 
		...
		enlarge y limits={0.06}, xmin={1989-12-30}, tick label style={inner sep=0pt},
		yticklabel style={text width=1em},
		xticklabel={`\short{\year}}, height=11.9cm, width=7.4cm, clip=false]
	\rbars
...
\hspace*{-3mm} \begin{tikzpicture} 
	\begin{axis}[\bbar{y}{0}, date coordinates in=x, axis line style={draw=none},
		...
		xticklabel style={align=center, xshift=1.1em},
...
\hspace*{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15}, 
		...
		enlarge y limits={0.08}, legend style={at={(0.98, 1.12)}, fill=white}]
	\rbars
...
\end{minipage} \hfill
\begin{minipage}{0.46\textwidth} \index{Tobin's Q}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{1992-01-01}}{8.2}{\footnotesize \color{blue!60!black}\textbf{Effective}\\\footnotesize \color{blue!60!black}\textbf{Fed Funds Rate}}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=7.2cm, width=7.7cm,	xmajorgrids, ymax=8.8, ymin=0.35,
		...
		xtick=data, xticklabels={1M, 3M, 6M, 1Y, 2Y, 5Y, 10Y, 20Y, 30Y}, legend cell align={left},
...
\hspace*{-3mm} \begin{tikzpicture}
    ...
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={-1, 0, 1, 2, 3}, ymin=-1.9, ymax=2.3,
    	yticklabel style={text width=1.2em}, 
...
\hspace*{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		...
		xticklabel={`\short{\year}}, clip=false, width=12.1cm, height=5.4cm]
	\rbars
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	...
	\rbar
	\ctsbar{blue!85!black}{date}{core_goods}{data/cpi_decomp.csv}{2.3pt}
	\ctsbar{green!60!black}{date}{core_services}{data/cpi_decomp.csv}{2.3pt}
	\ctsbar{cyan!50!white}{date}{shelter}{data/cpi_decomp.csv}{2.3pt}
	\ctsbar{orange!80!red}{date}{food_energy}{data/cpi_decomp.csv}{2.3pt}
