...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60},
		xmin={1989-12-01},
		xticklabel={`\short{\year}}, clip=false, ymin=3, yticklabel style={text width=1.0em},
...
\small When businesses purchase items with a useful life of more than one year it is considered a \href{https://www.bea.gov/help/glossary/nonresidential-fixed-investment}{fixed investment}, which is exchange of assets rather than an expense. Business fixed investment includes spending on structures, equipment, and software. \textbf{Investments in fixed assets make workers more productive}, as they allow businesses to produce more goods and services with the same hours of work. Business investments in fixed assets are grouped broadly as structures (see\cbox{yellow!50!orange}), equipment (see\cbox{cyan!60!white}), and intellectual property products (see\cbox{violet}). 
\vspace{5mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={1, 2, 3}, clip=false, ymin=1.05,
		xticklabel={`\short{\year}}, height=4.3cm, width=6.3cm]
	\rbars
...
\hspace*{-3mm} \noindent \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.1pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.55}
		 \begin{tabular}{p{32mm} R{7.9mm} R{7.9mm} R{7.9mm} R{7.9mm} R{7.9mm} R{7.9mm} 
		   R{7.9mm} R{12.8mm} R{11.2mm}}
