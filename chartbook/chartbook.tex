...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={1.2, 1.3, 1.4, 1.5, 1.6}, 
		xticklabel={`\short{\year}}, width=7.8cm]
	\rbars
	\stdline{blue!60!green}{date}{VALUE}{data/isratio.csv}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: FRED} \hfill \tbllink{isratio.csv}\\
\end{minipage} \hspace{8mm}
\begin{minipage}{0.28\textwidth}
\small Census reports the ratio of inventories to sales for the total business sector.
\end{minipage}
