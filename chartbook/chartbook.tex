...
\small Ideally, try to capture the contributions to the change in net worth. This might not be possible, but would be interesting. Net worth can change from changes to income, changes to the rate at which income is saved, changes to borrowing and changes in interest rates (changes in the value of liabilities), and changes to the value of assets. This is complicated, so just start with assets and liabilities. \\
