...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.9cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.55cm}{4.0cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
	\stdnode{3.8cm}{0.78cm}{\footnotesize \color{green!90!blue}State}
	\end{axis}
\end{tikzpicture}\\
