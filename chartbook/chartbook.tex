...
Beyond content, I still need to do/add: links to subsection, links to sources, links to data, links to code, date of last update, list of charts and numbering system, links between charts and references, marks for recent updates, explicitly note seasonal adjustment, and much much more. \\
...
\small Domestic liabilities increased by X.X percent in 2019 Q3, after adjusting for inflation. Over the past three years, domestic liabilities have increased at an average annual rate of X.X percent. Federal government liabilities contributed X.X percentage points per year on average, while state and local contributed X.X percent per year on average. Households contributed X.X percent per year on average over this three year period, corporate businesses contributed X.X percent and non corporate businesses contributed X.X percent.\\
...
Paragraph here about trends in auto loans, credit card debt, and student loans.
...
Over the past X.X. etc. text here on recent data with focus on annual average since there seems to be some seasonality in the data. \\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\thickline{orange!80!red}{date}{Manufacturing}{data/indpro.csv}
...
\small The Federal Reserve's monthly industrial production report also measures the economy's total industrial capacity. The extent to which the economy is using its industrial capacity is called capacity utilization, and calculated as industrial production as a share of total industrial capacity. \input{text/tcu.txt}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\thickline{red!80!orange}{date}{Total index}{data/tcu.csv}
	\stdline{violet!80!purple}{date}{Manufacturing}{data/tcu.csv}
	\stdnode{9.0cm}{1.3cm}{\scriptsize \color{violet}\textbf{Manufacturing}}
	\stdnode{8.4cm}{2.2cm}{\scriptsize \color{red}\textbf{Total index}}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Census Bureau} \\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\thickline{blue!70!black}{date}{44W72}{data/marts.csv}
	\stdline{green!90!blue}{date}{44X72}{data/marts.csv}
	\stdnode{6.2cm}{0.65cm}{\scriptsize \color{green!90!blue}\textbf{Total}}
	\stdnode{7.8cm}{2.95cm}{\scriptsize \color{blue!70!black}\textbf{ex-auto \& ex-gas}}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Census Bureau} \\
...
\small Wage text goes here. Explain two sources and provide some basic numbers. \\

Wage data for low-wage earners is useful for understanding the extent to which the labor market is able to cover living expenses. \\
...
\small Text here on the fed funds rate.\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{6.2cm}{0.65cm}{\scriptsize \color{orange!70!yellow}\textbf{Twp-year}}
