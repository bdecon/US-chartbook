...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={64, 66, 68}, 
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={45, 50, 55, 60, 65, 70}, 
		enlarge y limits={0.1},
		xticklabel={`\short{\year}}, height=4.8cm, width=7.3cm, clip=false]
	\rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 5, 10, 15}, enlarge y limits={0.1},
		xticklabel={`\short{\year}}, clip=false, height=5.0cm, ymin=1,
