...
%
	...
	\fancypagestyle{sectpage}{\fancyhf{}\renewcommand{\headrulewidth}{0pt}
		\fancyhead[R]{\textcolor{blue!70}{\rule[-1pt]{5pt}{9pt}} \hspace{-1.5mm}
		\textcolor{green!70!blue}{\rule[-1pt]{5pt}{12pt}} \color{black!90} US Chartbook}
	...
	\pgfplotstableread[header=true, col sep=comma]{data/treas_recent_mon.csv}\treasmon
	...
	\pgfplotstableread[header=true, col sep=comma]{data/indprogr_rec.csv}\ipmo
...
\hspace*{-3mm}\begin{minipage}{0.45\textwidth}
\setlength{\parskip}{3.0pt}
\begin{description}
\tocentry{oea}{Overall Economic Activity}
...
\tocentry{ofa}{Overall Financial Activity}
\begin{description}[labelindent=-5mm]
...
\section*{Financial Accounts} \thispagestyle{sectpage}
...
\section*{Households} \index{households!overview}
\thispagestyle{sectpage}
\begin{minipage}{0.76\textwidth}
...
\hspace*{-1mm} \begin{tikzpicture}
    ...
    \nextgroupplot[\bbar{y}{0}, \shdateaxisticks 
		enlarge y limits={0.16}, ytick={-2, -1, 0, 1, 2, 3, 4},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.0cm, width=7.6cm, clip=false]
	\rbars
...
\hspace*{-4mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{2.5cm}{1.5ex}
    	width=4.8cm, bar width=3.6ex, height=5.2cm,
    	enlarge y limits={abs=0.35cm}, enlarge x limits=0.03, \bbar{x}{0},
...
\newpage 
\vspace{-3mm}
\begin{minipage}{0.82\textwidth} \index{income!personal}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20,
		ymin=3,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		yticklabel style={text width=1.5em}, width=12.5cm,
...
\begin{axis}[clip=false,
    ...
    xtick=data, ymin=0, width=6.7cm, height=5cm, bar width=22pt,
    ...
    enlarge x limits={0.16}, enlarge y limits={0.2, upper}, nodes near coords, 
    nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=1, assume math mode},
    ...
    \addplot[ybar,fill=blue, draw=blue] coordinates {
        ...
        (Hispanic,165.54)
        (Other,656.6)};
    \node[below, align=center, shift=({rel axis cs:0.5,1.08}), 
		draw=black!30!white, fill=white, inner sep=3.0]
...
\begin{axis}[clip=false,
    ...
    \addplot[ybar,fill=blue, draw=blue] coordinates {
        ...
        (Hispanic,36.1)
        (Other,74.5)};
    \node[below, align=center, shift=({rel axis cs:0.47,1.08}), 
		draw=black!30!white, fill=white, inner sep=3.0]
...
\hspace*{-1mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
		ymin=8, enlarge y limits={0.04}, 
		xticklabel={`\short{\year}}, yticklabel style={text width=1.5em}, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		height=8.4cm, width=7.6cm, clip=false]
	\rbars
	...
	\stdnode{4.35cm}{2.86cm}{\footnotesize \color{red!80!black}75--89.9}
	\stdnode{4.1cm}{2.0cm}{\footnotesize \color{green!80!blue!85!black}50--74.9}
	\stdnode{1.0cm}{1.0cm}{\footnotesize \color{red!20!orange!95!black}25--49.9}
	\stdnode{4.2cm}{0.5cm}{\footnotesize \color{violet}Less than 25}
	\end{axis}
\end{tikzpicture}\\
...
\Large{\color{red!80!white}\textbf{---}} \footnotesize{White, non-Hispanic} \ \ \ \Large{\color{blue!80!black}\textbf{---}} \footnotesize{Black, non-Hispanic} \ \ \ \Large{\color{magenta!50!violet}\textbf{---}} \footnotesize{Hispanic} \ \ \ \Large{\color{black!40!white}\textbf{---}} \footnotesize{Other}
\end{minipage}

\begin{minipage}{0.26\textwidth}
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 250, 500, 750, 1000}, ymin=0,
		yticklabel style={text width=1.7em}, enlarge y limits={value=0.2,upper},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.2cm, width=5.0cm, clip=false]
	\rbars
...
\begin{minipage}{0.26\textwidth}
\begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 100, 200, 300, 400, 500}, ymin=0,
		yticklabel style={text width=1.2em}, enlarge y limits={value=0.2,upper},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.2cm, width=4.95cm, clip=false]
	\rbars
...
\begin{minipage}{0.26\textwidth}
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 25, 50, 75, 100, 125, 150}, ymin=0,
		yticklabel style={text width=1.2em}, enlarge y limits={value=0.2,upper},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.2cm, width=4.95cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 100, 200, 300, 400, 500}, ymin=20,
		yticklabel style={text width=1.5em}, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.2cm, width=6.8cm, clip=false]
	\rbars
...
\hspace*{-3mm} \begin{tikzpicture} 
	...
	\end{axis}
\end{tikzpicture} \hfill 
\begin{tikzpicture} \begin{axis}[\bbar{y}{0}, \ltdateaxisticks 
...
\hspace*{-2mm} \begin{tikzpicture} 
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks xmin={2016-01-01}, 
		enlarge y limits={0.24}, max space between ticks=25,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		yticklabel style={text width=1.4em}, 
		clip=false, xticklabel={`\short{\year}}, height=6.0cm, width=7.6cm]
	\rbar
	...
	\absnode{{2020-12-01}}{3.02}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
	\absnode{{2016-06-01}}{2.1}{\footnotesize \color{blue!40!cyan} \ \ \ All \\ \footnotesize \color{blue!40!cyan}Other}
	\end{axis}
\end{tikzpicture}\\
...
\hspace{1mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks max space between ticks=30, 
		...
		tick label style={inner sep=0pt},
		height=3.6cm, width=6.4cm, xticklabel={`\short{\year}}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks \bbar{y}{0}, clip=false, 
		xticklabel={`\short{\year}}, height=9.6cm, width=6.4cm, 
		tick label style={inner sep=0pt},
		ymin=0.35, ymax=7.75]
	\rbars
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks width=6.2cm, 
		max space between ticks=20,	 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		height=6.4cm, clip=false, ymax=160,
		xticklabel={`\short{\year}}, yticklabel style={text width=1.6em}]
	\rbars
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks width=7.3cm, height=8.1cm,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
	...
	\absnode{{2019-03-01}}{-0.2}{\scriptsize Mar `20\\ \scriptsize -1.5\\ \scriptsize million}
	\absnode{{2020-06-15}}{5.2}{\scriptsize Jun `20\\ \scriptsize +4.5 million}
	\absnode{{2019-06-01}}{5.3}{\scriptsize May `20\\ \scriptsize +2.6\\ \scriptsize million}
...
\hspace*{2mm} \begin{tikzpicture}
	...
	\node[below, align=left, shift=({rel axis cs:0.18,1.34}), 
	draw=black!30!white, fill=white, inner sep=3.5]
...
\begin{tikzpicture}
  	\begin{axis}[ybar=20pt, 
    	width=6.0cm, bar width=22pt, height=4.2cm, ytick=false,
  		ymajorticks=false, axis line style={draw=none}, x tick style={color=white},
	...
	\node[below, align=left, shift=({rel axis cs:0.38,1.44}), 
	draw=black!30!white, fill=white, inner sep=3.5]
		{\small \color{black!80!white}\textbf{Industry Wage Group*}};
	\node[below, align=left, shift=({rel axis cs:0.14,1.2})]
...
\begin{minipage}{0.76\textwidth} 
\small BLS also \href{https://data.bls.gov/timeseries/LNU02374597}{report} the \textbf{employment rate for people with disabilities}. People with disabilities may be limited in their ability to participate in labor markets and can also face discrimination during hiring. Labor market prospects for the group are also affected by economic conditions. A tight labor market pushes businesses to accommodate disabilities and to discriminate less in hiring.
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ymin=1.9, 
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		width=7.6cm, enlarge y limits={0.06},
		xticklabel={`\short{\year}}, clip=false, height=7.8cm]
	\recbars
	\stdline{red}{date}{BLS}{data/dis_emp_rate_bls.csv}
	\stdline{blue}{date}{Age1664}{data/dis_emp_rate_cps.csv}
	\absnode{{2011-01-01}}{15.2}{\footnotesize \color{red}\textbf{Age 16 and older}}
	\absnode{{2013-01-01}}{33.2}{\footnotesize \color{blue}\textbf{Age 16 to 64}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shticks
	\bbar{y}{0}, height=5.3cm, width=6.65cm, yticklabel style={text width=1.6em}, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shticks
	\bbar{y}{0}, height=5.6cm, width=6.5cm, yticklabel style={text width=2.2em}, 
		ymin=0, enlarge y limits={lower, 0.0}, enlarge x limits={0.01}, xtick=data,
		minor xtick={{2022-01-01}, {2023-01-01}, {2024-01-01}},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		clip=false, xticklabel style={align=center}, minor tick length=7pt, 
...
\hspace*{-4mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{1.8cm}{1.5ex}
    	width=3.7cm, bar width=1.65ex, height=5.4cm,
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={}, width=8.2cm, height=8.25cm,
...
\hspace{20mm} \begin{tikzpicture}[overlay]
	\begin{axis}[clip=false,
            \barylab{2.4cm}{1.2ex}, stack negative=separate, ymajorgrids=false,
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20, 
		...
		xticklabel={`\short{\year}}, ymax=11.0,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		clip=false, width=12.7cm, height=5.6cm, 
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{1}, \shdateaxisticks 
		enlarge y limits={0.08}, xticklabel={`\short{\year}}, ymax=0.98,
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		clip=false, width=8.1cm, height=5.6cm, 
		yticklabel style={text width=1.5em}]
	\rbars
	\thickline{red}{date}{GWG}{data/gwg.csv}
	\input{text/gwg_node.txt}
	\absnode{{1991-01-01}}{1}{\footnotesize \color{gray} \textit{Pay equality}}
	\end{axis}
\end{tikzpicture}

\footnotesize{Source: Bureau of Labor Statistics} \hfill \tbllink{gwg.csv}
\end{minipage} \hspace{5mm} \begin{minipage}{0.26\textwidth}
...
\footnotesize{\textit{private production and non-supervisory workers, as of \input{text/ahe_bar_date.txt}}} \hspace{4mm} \cbox{blue!70!violet} Service-Providing
\end{minipage}
\vspace{8.4cm}
...
\hspace{1mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=30,
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, width=7.5cm, height=5.9cm, clip=false]
	\rebars
	\stdline{cyan!90!white}{date}{Be}{data/eci.csv}
	\stdline{green!75!blue!60!black}{date}{WS}{data/eci.csv}
	\input{text/eci_nodes.txt}
	\absnode{{2016-06-01}}{5.6}{\footnotesize \color{green!75!blue!60!black}Wages \&\\\footnotesize \color{green!75!blue!60!black}Salaries}
	\absnode{{2004-08-01}}{7.6}{\footnotesize \color{cyan!90!white}Benefits}
	\end{axis}
\end{tikzpicture}
...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\nextgroupplot[\ltdateaxisticks ytick={2, 3, 4, 5}, 
		enlarge y limits={0.18}, %name=ax2, 
	...
	\nextgroupplot[\ltdateaxisticks 
		enlarge y limits={0.18}, %name=ax4, 
		yticklabel style={text width=1.0em}, 
    	tick label style={inner sep=0pt},
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	...
	\end{axis} 
	\begin{axis}[name=plot2, at={($(plot1.south east)+(0.6cm,0.2cm)$)}, anchor=south west, \bbar{y}{0}, \shticks xtick=data,
		clip=false, 
		enlarge x limits={0}, 
		enlarge y limits={0.16},
