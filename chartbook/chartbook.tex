...
\normalsize \textbf{Unemployment Rate}\small \hspace{8mm} \cbox{green} \input{text/cps_lfs_date.txt}\\
\footnotesize{\textit{unemployed share of labor force}}\small \hspace{4mm} \cbox{cyan!50} \input{text/cps_lfs_dateyr.txt}\\
\footnotesize{\textit{three month average}}
\vspace{-1mm}

\hspace*{-2mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{2.1cm}{1.5ex}
    	width=5.8cm, bar width=1.6ex, height=5.2cm,
    	enlarge y limits={abs=0.35cm}, enlarge x limits=0.05, \bbar{x}{0},
