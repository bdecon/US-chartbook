...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{7.8cm}{2.4cm}{\scriptsize \color{blue!70!black}\textbf{Nonstore}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{2.1cm}{1.45cm}{\footnotesize \color{blue!70!black}Individual\\\color{blue!70!black}Income\\\color{blue!70!black}Taxes}
