...
\footnotesize{\textit{breakeven rate implied by treasury yields, percent}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks ytick={0, 0.5, 1.0, 1.5, 2.0}, 
	...
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: FRED} \hspace{39mm} \tbllink{infbreak.csv}
\end{minipage}
