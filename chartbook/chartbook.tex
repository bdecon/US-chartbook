...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-30, -20, -10, 0, 10, 20, 30},
		...
		legend style={at={(0.54, 1.0)}, fill=white}]
	\rbars
...
\small Total liabilities is the outstanding debt at a point in time. While the vast majority of US borrowing comes from US lending, that is the net result on balance sheets is zero, it is still useful to consider how total liabilities vary by major sector and over time. 
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\draw [dashed] (axis cs:{2002-01-01},\pgfkeysvalueof{/pgfplots/ymin}) -- (axis cs:{2002-01-01},
		\pgfkeysvalueof{/pgfplots/ymax});
	\absnode{{1997-07-01}}{3}{\scriptsize historical}
	\absnode{{2002-06-01}}{3}{\scriptsize revised}
	\sbar{cyan!70!white}{date}{Renter}{data/hhform.csv}
	\sbar{teal!70!green!85!black}{date}{Owner}{data/hhform.csv}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\absnode{{1992-01-01}}{40}{\footnotesize \color{blue!75!black}Income}
	\stdline{blue!75!black}{date}{DPI}{data/inc_out_save.csv}
	\absnode{{2011-01-01}}{40}{\footnotesize \color{orange}Spending}
	\stdline{orange}{date}{PCE}{data/inc_out_save.csv}
	\absnode{{2014-01-01}}{9}{\footnotesize \color{green!80!blue}Saving}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60, 70, 80}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=8.8cm, width=7.8cm]
	\rbars
	\stdnode{4.5cm}{2.7cm}{\footnotesize \color{blue!50!cyan}Income}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-10, -5, 0, 5, 10, 15, 20, 25, 30}, 
		yticklabel style={text width=1.4em}, 
...
\small Labor income, which includes wages and salaries as well as self-employment income, is the vast majority of personal income. Over calendar year 2020, 51 percent of people have any labor income (see\cbox{red!70!yellow}). Only 43 percent of people have labor income above the single-person poverty threshold of \$12,880.

Total income (see\cbox{violet!90!blue}) reaches 73 percent of people in 2019. Total income includes after-tax labor income plus welfare and capital income. People who did not receive any income by the total income measure typically live with people who receive income. 
\vspace{2mm}
...
\begin{tikzpicture}
	\begin{axis}[ymin=0, ymax=100, enlarge x limits={0.02},
		width=7.6cm, height=5.4cm, ytick={0, 12.9, 50, 100},
		legend cell align={left}, yticklabel style={text width=1.8em}, 
		legend style={legend columns=1, at={(0.42, 0.95)}}]
	\abar{red!70!yellow}{percentile}{Earnings}{data/pearn_dist.csv}
	\abar{violet!90!blue}{percentile}{Other Income}{data/pearn_dist.csv}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-30, -20, -10, 0, 10, 20, 30},
		xticklabel={`\short{\year}}, clip=false, height=6.68cm,
		yticklabel style={text width=1.5em}, enlarge y limits={0.02},
		legend style={at={(0.41, 0.98)}}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-20, -10, 0, 10, 20},
		xticklabel={`\short{\year}}, clip=false, height=8.4cm,
		yticklabel style={text width=1.4em}, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={16, 18, 20, 22, 24, 26}, 
		enlarge y limits={0.1}, height=6.4cm, width=12.2cm, 
		yticklabel style={text width=1.0em}, 
		xticklabel={`\short{\year}}, clip=false]
	\rbars
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-10, 0, 10, 20}, height=6.2cm, 
		xticklabel={`\short{\year}}, yticklabel style={text width=1.5em}, clip=false, 
		legend style={at={(0.92, 1.01)}, fill=white}]
	\rbars
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10, 15, 20, 25},
		height=6.2cm, xticklabel={`\short{\year}}, 
		yticklabel style={text width=1.5em}, clip=false, 
		legend style={at={(0.92, 1.11)}}]
	\rbars
...
\begin{minipage}{0.76\textwidth}
\small The Federal Housing Finance Agency (FHFA) \href{https://www.fhfa.gov/DataTools/Downloads/Pages/House-Price-Index-Datasets.aspx}{housing price index} measures changes in the price of the same home. The seasonally-adjusted index \input{text/fhfa.txt}
...
\newpage
\begin{minipage}{0.76\textwidth}
\small Poverty can be geographically concentrated. In the United States, some regions have particularly high and persistent poverty rates. 
\end{minipage}
\vspace{2mm}
...
\footnotesize{\textit{Share of commuting zone householders with after-housing-expense annual income below \$15,189}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-30, -20, -10, 0, 10, 20, 30}, 
		yticklabel style={text width=1.5em}, height=7.0cm, 
		xticklabel={`\short{\year}}, clip=false, legend style={at={(0.88, 1.09)}}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={60, 70, 80}, width=12.3cm, 
		height=7.8cm, clip=false, xticklabel={`\short{\year}}]
	\rbars
...
\small Since 2011, annualized total US \textbf{electricity generation} has remained fairly constant at around four trillion kilowatt hours. \input{text/elec_prod.txt}
\end{minipage}
\vspace{2mm}
...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\stdnode{4.5cm}{5.0cm}{\footnotesize \color{green!60!blue}\textbf{GDP}}
	\stdnode{4.0cm}{3.65cm}{\footnotesize \color{blue!90!black}\textbf{Population}}
	\stdnode{4.7cm}{3.0cm}{\footnotesize \color{red}\textbf{Electricity}}
	\stdnode{5.4cm}{1.75cm}{\footnotesize \color{orange}\textbf{Electricity per capita}}
	\stdnode{4.9cm}{0.55cm}{\footnotesize \color{cyan}\textbf{Electricity / GDP}}	
	\end{axis}
\end{tikzpicture}\\
...
\small The Energy Information Administration \href{https://www.eia.gov/electricity/monthly/}{report} the retail sales of electricity to each major sector. These data show a decrease in electricity sales to commercial and industrial sectors during the pandemic, offset in part by increased electricity sales to the residential sector. 
\end{minipage}
...
\hypertarget{busrs}{}
\small \input{text/marts.txt} Nonstore sales growth is smoothed in the chart below by taking the three-month moving average (see {\color{blue!70!black}\textbf{---}}).
\vspace{2mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdline{green!80!blue}{date}{44X72}{data/marts.csv}
	\input{text/rs_ns3m_node.txt}
	\input{text/rs_44x72_node.txt}
	\absnode{{2017-10-01}}{-3}{\scriptsize \color{green!80!blue}\textbf{Total}}
	\absnode{{2014-01-01}}{19}{\scriptsize \color{blue!70!black}\textbf{Nonstore}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{3.8cm}{1.5ex}
    	width=6.2cm, bar width=1.7ex, height=9.6cm,
    	enlarge y limits={abs=0.3cm}, enlarge x limits=0.12, \bbar{x}{0},
		yticklabels from table={\rs}{name}, 
		yticklabel style={font=\footnotesize}, nodes near coords, 
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=2, assume math mode},
		legend style={text=black!70, at={(1.08,0.15)}, legend columns=1, 
				fill=none, draw=none}]
	\addplot[fill=teal!50!green, draw=none] 
 	...
 	\legend{\input{text/rs_mon2.txt}, \input{text/rs_mon1.txt}}
  	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Census Bureau, BEA} \hfill \tbllink{rs_comp.csv}
\end{minipage}
\newpage
\begin{minipage}{0.76\textwidth}
\section*{Government}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100}, width=12.8cm,
		xticklabel={`\short{\year}}, clip=false, ymin=4, ymax=112, height=6.0cm,
		legend cell align={left}, yticklabel style={text width=1.5em}, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-8, -6, -4, -2, 0, 2, 4}, 
		...
		height=5.6cm, enlarge y limits={0.01}, 
		xticklabel={`\short{\year}}, clip=false, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30, 40}, ymin=1,
		yticklabel style={text width=1.0em}, height=5.8cm, 
...
\vspace{-0.5mm}
\small The \href{https://home.treasury.gov/data/treasury-international-capital-tic-system}{purchases and sales} of US bonds by the rest of the world give insight into overall capital flows and appetite for different types of debt. During the 2000s, other countries were accumulating US corporate and government bonds, as the US was borrowing from the rest of the world and running a very wide trade deficit. During the pandemic, the rest of the world has been a net purchaser of US government agency bonds but a net seller of treasuries. 
\vspace{1mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{1}, \dateaxisticks ytick={0.5, 1, 1.5}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=6.2cm]
	\rbars
	...
	\stdnode{10.0cm}{0.8cm}{\footnotesize \color{blue!90!cyan}GBP}
	\stdnode{5.2cm}{3.6cm}{\footnotesize \color{green!85!blue}CAD}
	\stdnode{3.7cm}{1.4cm}{\footnotesize \color{cyan!90!white}EUR}
	\stdnode{1.4cm}{1.5cm}{\footnotesize \color{red}JPY (100)}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Federal Reserve} \hfill \tbllink{fx1.csv}
\vspace{3mm} 

\small The Federal Reserve \href{https://www.federalreserve.gov/releases/h10/summary/default.htm}{trade-weighted dollar indices} show weighted-average foreign exchange rates with US trading partners. These US dollar indices can simplify analysis of the overall role of foreign exchange rates on the US external sector. 
\end{minipage}
\vspace{0.5mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{1}, \dateaxisticks ytick={90, 100, 110, 120}, 
		...
		xticklabel={`\short{\year}}, width=6.2cm, height=5.6cm,
		clip=false]
	\recbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \lfdateaxisticks xticklabel={`\short{\year}}, 
	ytick={0, 2, 4, 6}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20, 25}, 
		yticklabel style={text width=1.0em}, 
		enlarge y limits={0.1}, ymin=2, xmin={1989-12-01},
	...
	\stdnode{3.7cm}{0.7cm}{\footnotesize \color{blue!50!cyan}U3}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 5, 10, 15, 20}, 
		enlarge y limits={0.1}, yticklabel style={text width=1.0em},
		xticklabel={`\short{\year}}, clip=false, height=4.8cm, ymin=1.7,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30, 40, 50}, 
		...
		yticklabel style={text width=1.2em},
		xticklabel={`\short{\year}}, height=5.2cm, width=12.4cm, clip=false]
	\rbars
...
\small The current population survey interviews households up to eight times over 16 months, allowing insight into the labor force status of the same individual over time, and in particular, into flows between different employment, unemployment, and other categories. The Bureau of Labor Statistics \href{https://www.bls.gov/cps/cps_flows.htm}{publish} many monthly indicators based on labor force flows, and others can be calculated directly from the public use data.
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={40, 50, 60, 70}, 
		yticklabel style={text width=1.0em}, xticklabel={`\short{\year}}, 
		clip=false, height=5.8cm, width=12.2cm,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 2, 4, 6, 8, 10, 12, 14}, 
		...
		xticklabel={`\short{\year}}, height=7.8cm]
	\rbars
	...
	\stdnode{3.0cm}{2.75cm}{\footnotesize \color{cyan}\textbf{Hires}}
	\stdnode{8.3cm}{3.3cm}{\footnotesize \color{blue!80!black}\textbf{Openings}}
	\stdnode{8.0cm}{1.6cm}{\footnotesize \color{red!85!violet}\textbf{Quits}}
	\stdnode{2.4cm}{0.55cm}{\footnotesize \color{orange!70!yellow}\textbf{Layoffs}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 2, 4, 6}, clip=false,
		xticklabel={`\short{\year}}, ymin=0.3, height=5.6cm, width=6.8cm]
	\rebars
	\thinline{red!50!purple}{date}{AFS_QU}{data/quits.csv}
	\stdnode{3.5cm}{3.28cm}{\scriptsize \color{red!50!purple}\textbf{Accommodations}\\
	...
	\stdnode{3.8cm}{0.75cm}{\scriptsize \color{violet}\textbf{Total nonfarm}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 0.5, 1.0, 1.5, 2.0}, 
		yticklabel style={text width=1.3em}, 
		ymin=0.08, ymax=1.9,
		xticklabel={`\short{\year}}, height=5.0cm, width=12.4cm, clip=false]
	\rebars
...
\small Job switching is important for getting people into the jobs where they are most productive. Switching to a more productive industry or moving from a less-productive firm to a more-productive firm, both boost labor productivity. 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-50, -40, -30, -20, -10, 0, 10, 20, 30, 40}, 
		yticklabel style={text width=1.5em}, width=12.8cm, height=9.2cm,
		xticklabel={`\short{\year}}, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={0, 2, 4, 6}, 
		...
		xticklabel={`\short{\year}}, height=4.5cm, width=7.3cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks clip=false,
		...
		xticklabel={`\short{\year}}, height=5.0cm, width=7.3cm]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 2, 4, 6, 8}, 
		...
		xticklabel={`\short{\year}}, width=7.0cm, height=6.0cm, clip=false]
	\rebars
	\stdline{cyan!40!blue}{date}{Be}{data/eci.csv}
	\stdline{green!80!blue}{date}{WS}{data/eci.csv}
	\input{text/eci_nodes.txt}
	\absnode{{2016-05-01}}{5.6}{\scriptsize \color{green!80!blue}\textbf{Wages and}\\\scriptsize \color{green!80!blue}\textbf{Salaries}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={8, 10, 12, 14, 16, 18}, 
		yticklabel style={text width=1.0em}, 
		enlarge y limits={0.1}, 
		xticklabel={`\short{\year}}, height=5.0cm, width=12.2cm, clip=false]
	\rebars
...
\hypertarget{cap}{}
\vspace{-1mm}
\small The US equity and capital markets provide funding for borrowers' activities and provide a source of income to lenders. 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={0, 1000, 2000, 3000, 4000, 5000}, 
		enlarge y limits={0.1}, yticklabel style={text width=2.2em}, 
		xticklabel={`\short{\year}}, height=5.8cm, width=6.7cm, clip=false]
	\rbars
...
\hfill
\begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks ytick={2000, 2500, 3000, 3500, 4000, 4500, 5000}, 
		enlarge y limits={0.1}, yticklabel style={text width=2.2em}, 
		xticklabel={`\short{\year}}, height=5.8cm, width=5.9cm, clip=false]
	\rbar
	\thickline{black!13!white}{date}{MA}{data/sp500_recent.csv}
	\thinline{green!80!blue}{date}{GSPC}{data/sp500_recent.csv}
	\stdnode{1.3cm}{0.3cm}{\scriptsize \color{black!25!white}\textbf{moving average}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15}, 
		yticklabel style={text width=1.0em}, 
		xticklabel={`\short{\year}}, clip=false, 
		height=6.0cm, enlarge y limits={0.11}, legend style={at={(0.96, 1.05)}, fill=white}]
	\rbars
	\thickline{blue}{date}{Return10}{data/sp500rr.csv}
	\thickline{orange}{date}{Return15}{data/sp500rr.csv}
	\thickline{green!80!blue}{date}{Return20}{data/sp500rr.csv}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{2015-06-01}}{-1.8}{\footnotesize \color{cyan!80!white}\textbf{Modified}\\\scriptsize \color{cyan!80!white}\textbf{Taylor Rule}}
	\end{axis}
\end{tikzpicture}\\
...
\end{minipage} \hspace{4mm}
\begin{minipage}{0.33\textwidth}
\small The yield curve can also become \textit{inverted} when yields on shorter-term debt are higher than yields on longer-term debt. An inverted yield curve can be a sign of worsening economic conditions. For example, short term rates may exceed longer-term rates if the Federal Reserve cutting is expected to lower interest rates in the future, or if inflation is expected to fall due to weakened economic conditions. 
...
\begin{minipage}{0.76\textwidth}
\small Another measure of the term structure of interest rates is the \textit{spread} between treasuries with different maturities. This measure can be used to track changes in the term structure over time. 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={0, 1, 2, 3}, 
...
\small The US Treasury \href{https://www.treasury.gov/resource-center/economic-policy/corp-bond-yield/Pages/Corp-Yield-Bond-Curve-Papers.aspx}{publish} a yield curve for corporate bonds based on the market-weighted average of bonds rated AAA, AA, and A. \input{text/hqcb.txt}
\vspace{1mm} 
...
While the chartbook uses less-volatile 12-month inflation rates in most cases, the one-month rate can be more useful for examining short-term trends, for example by eliminating the base effects from changes in prices a year ago. \input{text/cpi_monthly.txt}
\vspace{1mm}
...
\small While some categories of spending have little impact on the average price basket or the overall CPI, large cumulative changes in the price of individual categories can have a huge impact on the lives of the individuals who pay them. For example, day care costs are paid generally only for a few years of a child's life and only some households contain day-care-age children. But within those households, day care is a large share of overall spending. 

The following section and table cover one-year inflation rates for different categories of goods and services, including some smaller categories. The table also shows the cumulative change in prices for each category since February 2020, the last month of data before the COVID-19 pandemic shutdown in the US. Additionally, the weight that a category has in the overall index--the category share of the basket of goods and services--is included as the last column in the table. This weight comes from each category's share of overall consumer spending during the most recent reference period, and is updated by changes in prices since the reference period. 
\end{minipage}
\newpage
\begin{minipage}{0.76\textwidth}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks ytick={0, 1, 2, 3}, 
		...
		xticklabel={`\short{\year}}, height=6.8cm, width=6.6cm]
	\rbar
	...
	\absnode{{2017-01-01}}{1.5}{\scriptsize \color{blue!70!black}\textbf{Market}}
	\absnode{{2017-03-01}}{2.9}{\scriptsize \color{violet!60!magenta}\textbf{Survey}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks ytick={0, 1, 2, 3, 4}, 
		...
		\stdnode{1.2cm}{0.7cm}{\scriptsize \color{blue!70!black}\textbf{Next 5 years}}
		\stdnode{1.85cm}{2.25cm}{\scriptsize \color{cyan}\textbf{Following 5 years}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\dateaxisticks ytick={-20, -10,  0, 10, 20}, 
		...
		yticklabel style={text width=1.6em},
		xticklabel={`\short{\year}}, height=6.0cm, width=12.0cm]
    	\rbars
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-20, -10,  0, 10, 20}, 
		...
		legend style={at={(0.98, 1.14)}},
		yticklabel style={text width=1.5em},
		height=5.4cm, enlarge y limits={0.08}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100, 125, 150}, 
		yticklabel style={text width=1.5em}, width=11.8cm, height=5.6cm,
