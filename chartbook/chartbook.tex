...
\noindent \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.8pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.55}
		 \begin{tabular}{p{2mm} p{36mm} R{7mm} R{7mm} R{7mm} R{7mm} R{7mm} p{0mm} R{7mm} R{7mm} R{7mm} }
			...
			\cbox{red!95!black}	 &	\textbf{Gross Domestic Product} & 2.1 & 3.1 & 0.6 & 1.3 & 2.9 & & 2.6 & 2.3 & 2.5 \\
			\cbox{yellow!80!orange}	 &	\hspace{2mm} Consumer Spending & 1.13 & 1.41 & 2.16 & 0.83 & 1.15 & & 2.13 & 1.28 & 1.38 \\
			& \hspace{4mm} Durable Goods & & & & & & & & & \\
			& \hspace{4mm} Non-durable Goods & & & & & & & & & \\
			\cbox{blue!70!black}	&	\hspace{2mm} Gross Investment & -0.91 & 0.34 & 0.69 & 1.03 & 0.14 & & 0.92 & 1.01 & 1.30 \\
			& \hspace{4mm} Residential & & & & & & & & & \\
			& \hspace{4mm} Non-residential & & & & & & & & & \\
			& \hspace{4mm} Change in inventories & & & & & & & & & \\
			\cbox{cyan!50!white}	&	\hspace{2mm} Government & 0.11 & -0.18 & 0.87 & 0.13 & 0.16 & & 0.03 & 0.34 & 0.29 \\
			& \hspace{4mm} Federal & & & & & & & & & \\
			& \hspace{4mm} State and Local & & & & & & & & & \\
			\cbox{green!60!black}	&	\hspace{2mm} Net Exports & -0.87 & -0.21 & -0.87 & 0.13 & 0.17 & & -0.48 & -0.48 & -0.56 \\ 
			& \hspace{4mm} Goods & & & & & & & & & \\
			& \hspace{4mm} Services & & & & & & & & & \\ 
			& & & & & & & & & & \\
			\cbox{purple!70!blue}	 &	\hspace{2mm} Goods and TTU & 1.13 & 1.41 & 2.16 & 0.83 & 1.15 & & 2.13 & 1.28 & 1.38 \\
			& \hspace{4mm} Manufacturing & & & & & & & & & \\			
			& \hspace{4mm} Construction & & & & & & & & & \\	
			& \hspace{4mm} Retail Trade & & & & & & & & & \\	
			\cbox{red!90!white}	&	\hspace{2mm} FIRE & -0.91 & 0.34 & 0.69 & 1.03 & 0.14 & & 0.92 & 1.01 & 1.30 \\
			\cbox{blue!90!white}	&	\hspace{2mm} Other Services & 0.11 & -0.18 & 0.87 & 0.13 & 0.16 & & 0.03 & 0.34 & 0.29 \\
			& \hspace{4mm} Education \& Healthcare & & & & & & & & & \\
			\cbox{orange!80!white}	&	\hspace{2mm} Government & 0.11 & -0.18 & 0.87 & 0.13 & 0.16 & & 0.03 & 0.34 & 0.29 \\
			& & & & & & & & & & \\
			\cbox{lime}	 &	\hspace{2mm} Population & 1.13 & 1.41 & 2.16 & 0.83 & 1.15 & & 2.13 & 1.28 & 1.38 \\
			\cbox{green!30!teal!90!black}	&	\hspace{2mm} Employment Rate & -0.91 & 0.34 & 0.69 & 1.03 & 0.14 & & 0.92 & 1.01 & 1.30 \\
			\cbox{cyan!50!white}	&	\hspace{2mm} Productivity & 0.11 & -0.18 & 0.87 & 0.13 & 0.16 & & 0.03 & 0.34 & 0.29 \\
			\cbox{blue}	&	\hspace{2mm} Average Hours & -0.87 & -0.21 & -0.87 & 0.13 & 0.17 & & -0.48 & -0.48 & -0.56 \\ 
			& & & & & & & & & & \\ 
			&	\textbf{Gross Domestic Income} & 1.13 & 1.41 & 2.16 & 0.83 & 1.15 & & 2.13 & 1.28 & 1.38 \\
			\cbox{magenta!90!blue}	 &	\hspace{2mm} Labor & 1.13 & 1.41 & 2.16 & 0.83 & 1.15 & & 2.13 & 1.28 & 1.38 \\
			& \hspace{4mm} Rate of Pay & & & & & & & & & \\			
			& \hspace{4mm} Hours of Work & & & & & & & & & \\				
			\cbox{yellow!60!orange}	&	\hspace{2mm} Profit & -0.91 & 0.34 & 0.69 & 1.03 & 0.14 & & 0.92 & 1.01 & 1.30 \\
			\cbox{teal!60!white}	&	\hspace{2mm} Depreciation & 0.11 & -0.18 & 0.87 & 0.13 & 0.16 & & 0.03 & 0.34 & 0.29 \\
			\cbox{violet}	&	\hspace{2mm} Indirect Taxes & -0.87 & -0.21 & -0.87 & 0.13 & 0.17 & & -0.48 & -0.48 & -0.56 \\ 
		\end{tabular}
		}	\\
