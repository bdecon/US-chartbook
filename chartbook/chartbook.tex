...
%
	...
	\newcommand{\rbars}{
		...
		\fill[color=black!10] (axis cs:{2020-02-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
			(axis cs:{2021-04-30}, \pgfkeysvalueof{/pgfplots/ymax});}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\stdnode{1.1cm}{4.1cm}{\footnotesize \color{blue!75!black}Income}
	\stdline{blue!75!black}{date}{DPI}{data/inc_out_save.csv}
	\stdnode{4.6cm}{4.2cm}{\footnotesize \color{orange}Spending}
	\stdline{orange}{date}{PCE}{data/inc_out_save.csv}
	\stdnode{5.0cm}{0.95cm}{\footnotesize \color{green!80!blue}Saving}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60, 70, 80}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=8.8cm, width=7.8cm]
	\rbars
	\stdnode{4.5cm}{2.8cm}{\footnotesize \color{blue!50!cyan}Income}
	\stdline{blue!50!cyan}{date}{INCAFTTX_4}{data/medincexp.csv}
	\stdnode{4.6cm}{2.0cm}{\footnotesize \color{red!50!orange}Spending}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15}, 
		yticklabel style={text width=1.0em}, 
		xticklabel={`\short{\year}}, clip=false, height=5.6cm, width=12.3cm]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{7.9cm}{3.2cm}{\color{green!70!blue!80!black}Fed G.19}
	\end{axis}
\end{tikzpicture}\\
...
\newpage
\begin{minipage}{0.76\textwidth}
\small Changes in net worth come mostly from changes in the value of assets (see\cbox{cyan!40!white}), but also from saving of income, and decisions about how much to spend.
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-20, -10, 0, 10, 20, 30}, 
		xticklabel={`\short{\year}}, yticklabel style={text width=1.4em},
	...
	\stdnode{9.5cm}{1.5cm}{\scriptsize \color{green!90!blue}\textbf{Total}}
	\stdnode{7.8cm}{3.2cm}{\scriptsize \color{blue!70!black}\textbf{Nonstore}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{1.05cm}{9.5cm}{\scriptsize \color{blue}\textbf{Total (LFS)}}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-40, -30, -20, -10, 0, 10, 20, 30, 40}, 
		yticklabel style={text width=1.5em}, width=12.9cm, height=7.8cm,
		xticklabel={`\short{\year}}, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\thinline{orange!45!yellow}{date}{VALUE}{data/gold.csv}
	\end{axis}
\end{tikzpicture}\\
