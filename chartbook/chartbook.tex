...
\footnotesize{Source: Bureau of Labor Statistics} \hspace{19mm} \tbllink{quits_ind.csv}
...
\footnotesize{Source: Bureau of Labor Statistics} \hspace{19mm} \tbllink{openings_ind.csv}
...
The S\&P 500 is a market-cap-weighted stock market index based on 500 large companies that are listed on US exchanges. The index is a broad measure of price levels in US equity markets. \input{text/sp500.txt}\\

\vspace{2mm}

\noindent \normalsize \textbf{S\&P 500}\\
\footnotesize{\textit{index}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={0, 1000, 2000, 3000, 4000}, 
		enlarge y limits={0.1}, 
		xticklabel={`\short{\year}}, height=5.6cm, width=7.2cm, clip=false]
	\rbars
	\stdline{green!80!blue}{date}{GSPC}{data/sp500.csv}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Yahoo! Finance} \hspace{26mm} \tbllink{sp500.csv} 
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 1, 2, 3}, 
		...
		xticklabel={`\short{\year}}, height=5.6cm, width=7.6cm, clip=false]
	\thinline{cyan!60!blue}{date}{Value}{data/spread.csv}
	\input{text/spread_node.txt}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Federal Reserve} \hspace{30mm} \tbllink{spread.csv} \\
