...
%
	...
	\newcommand{\rbars}{
		...
		\fill[color=black!10] (axis cs:{2020-02-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
			(axis cs:{2021-04-15}, \pgfkeysvalueof{/pgfplots/ymax});}
	...
	\newcommand{\rbar}{
		\fill[color=black!10] (axis cs:{2020-02-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
			(axis cs:{2021-03-30}, \pgfkeysvalueof{/pgfplots/ymax});}
...
\rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.1pt} \color{black!90}
	{\renewcommand{\arraystretch}{1.52}
		\begin{tabular}{p{39.5mm} R{8.2mm} R{8.2mm} R{8.2mm} R{6.7mm} R{6.7mm} 
		   R{7.8mm} R{6.7mm} R{6.7mm} }
			 \input{data/pi.tex}
			 \hline
		\end{tabular}}\vspace{-2mm}
...
\rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.0pt} \color{black!90}
	{\renewcommand{\arraystretch}{1.55}
\hspace*{-2mm} \begin{tabular}{p{2.0mm} p{39mm} R{8.2mm} R{8.2mm} R{8.2mm} R{7.2mm} R{7.2mm} 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 0.5, 1.0, 1.5, 2.0}, width=12.1cm, 
		height=6.2cm, clip=false,
		xticklabel={`\short{\year}}, yticklabel style={text width=1.5em}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={58, 60, 62, 64, 66, 68, 70, 72}, 
		enlarge y limits={0.1},
		yticklabel style={text width=1.0em},
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.0cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.6cm}{4.10cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
	\stdnode{3.9cm}{0.78cm}{\footnotesize \color{green!90!blue}State}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	...
	\addplot[ultra thick, mark=*, mark options={fill=white}, nodes near coords, 
		...
		node[pos=0.8,pin=280:{\textbf{Most recent}}] {};						 	
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Federal Reserve}
\end{minipage} \hspace{6mm}
...
\begin{tabular}{p{41mm} R{7.0mm} R{7.0mm} R{7.0mm} R{7.0mm}
		 		 R{7.0mm} R{7.0mm} R{10mm}} % R{7.0mm}
