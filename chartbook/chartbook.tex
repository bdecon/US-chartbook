...
\begin{minipage}{0.76\textwidth}
\small
The Census Bureau \href{https://www.census.gov/library/publications/2019/demo/p60-268.html}{reports} 41.2 million people in poverty in the US in 2018, more than the total population of Canada. For purposes of program eligibility and economic data, poverty is defined by having income below a certain threshold. The processes for calculating the threshold vary, with the official measure being based on roughly three times a typical food budget, and the supplemental measure additionally capturing program benefits and taxes.\\
