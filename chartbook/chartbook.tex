...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 1, 2, 3, 4, 5, 6}, ymin=0.15,
		height=5.4cm, width=13.0cm, enlarge y limits={0.05}, ymax=5.1,
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{1994-01-01}}{13.8}{\footnotesize \color{green!85!blue}Shelter}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{1993-11-01}}{26.5}{\footnotesize \color{red!50!orange} Top 1\%}
