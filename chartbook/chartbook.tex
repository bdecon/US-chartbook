...
%
	...
	\newcommand{\rbars}{
		...
		\fill[color=black!10] (axis cs:{2020-02-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
			(axis cs:{2020-08-01}, \pgfkeysvalueof{/pgfplots/ymax});}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{6.4cm}{1.8cm}{\scriptsize \color{green!90!blue}\textbf{Total}}
	\stdnode{7.8cm}{2.7cm}{\scriptsize \color{blue!70!black}\textbf{Nonstore}}
	\end{axis}
\end{tikzpicture}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{1}, \dateaxisticks ytick={90, 100, 110, 120}, 
		...
		xticklabel={`\short{\year}}, width=6.0cm, height=6.0cm]
	\rbars
