...
\small Changes in consumer spending can be categorized by major type of product: goods (see\cbox{red}), housing and utilities (see\cbox{green!80!black}), and household spending on all other services (see\cbox{blue!80!white}). 
\vspace{5mm}

\noindent \normalsize \textbf{Real PCE Growth by Major Type}\\
\footnotesize{\textit{percentage point contribution to personal consumption expenditure growth}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5},
		xticklabel={'\short{\year}}, clip=false, 
		legend style={at={(0.95, 1.13)}}]
	\rbars
	\sbar{red}{date}{DGDSRZ}{data/pce.csv}
	\sbar{blue!80!white}{date}{OTHSER}{data/pce.csv}
	\sbar{green!80!black}{date}{DHUTRZ}{data/pce.csv}
	\legend{Goods, Other Services, Housing and Utilities};
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Bureau of Economic Analysis}
\end{minipage}
