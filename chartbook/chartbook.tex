...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ymin=0, 
		max space between ticks=30,
		yticklabel style={text width=1.0em}, xmin={2007-11-01},
		width=7.0cm, enlarge y limits={0},
		xticklabel={`\short{\year}}, clip=false, height=7.6cm]
	\recbars
	\stdline{red}{date}{BLS}{data/dis_emp_rate_bls.csv}
	\stdline{blue}{date}{Age1664}{data/dis_emp_rate_cps.csv}
	\absnode{{2012-03-01}}{16}{\footnotesize \color{red}\textbf{Age 16 and older}}
	\absnode{{2014-07-01}}{26}{\footnotesize \color{blue}\textbf{Age 16 to 64}}
