...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\rbars
	\ctsbar{green!75!black}{date}{LABOR}{data/pi_levels.csv}{0.7pt}
	\ctsbar{orange!40!yellow}{date}{CAPITAL}{data/pi_levels.csv}{0.7pt}
	\ctsbar{blue!80!white}{date}{TRANSFER}{data/pi_levels.csv}{0.7pt}
...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\rbars
	\ctsbar{green!50!teal!85!blue}{date}{Employed}{data/cps_lfs.csv}{0.6pt}
	\ctsbar{lime!80!yellow!90!white}{date}{Unemployed}{data/cps_lfs.csv}{0.6pt}
	\ctsbar{blue!80!cyan}{date}{NILF}{data/cps_lfs.csv}{0.6pt}
	\ctsbar{cyan!80!white}{date}{Children}{data/cps_lfs.csv}{0.6pt}
...
\footnotesize{\textit{seasonally adjusted, thousands \hspace{10mm}levels \hspace{19mm} monthly change \hspace{32mm} combined}\\
\vspace{-5mm}
