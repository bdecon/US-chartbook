...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\sbar{cyan!40!white}{date}{SLG NFA}{data/govassets.csv}
	\sbar{blue!92!white}{date}{SLG FA}{data/govassets.csv}
	\sbar{magenta!90!white}{date}{FG NFA}{data/govassets.csv}
	\sbar{blue!25!violet}{date}{FG FA}{data/govassets.csv}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 500, 1000, 1500, 2000}, 
		xticklabel={`\short{\year}}, ymin=60, width=6.1cm]
	\rbars
