...
%
	...
	\newcommand{\lfdateaxisticks}{
		...
		xtick={{2018-01-01}, {2019-01-01}, {2020-01-01}, {2021-01-01}, {2022-01-01}, {2023-01-01}, {2024-01-01}},
...
\textbf{Version 0.1 release planned for November 2023}
\end{minipage}
\newpage
...
\tocentry{hh}{\cbox{red} Households}
\begin{description}[labelindent=-2mm]
...
\tocentry{bus}{\cbox{blue} Businesses}
\begin{description}[labelindent=-2mm]
...
\tocentsm{exiip}{International Investment Position}
...
\tocentsm{labh}{Hours}
\tocentsm{labns}{Nonstandard Work Arrangements}
\tocentsm{labw}{Wages}
...
\tocentry{cap}{\cbox{orange} Capital Markets}
\begin{description}[labelindent=-2mm]
...
\hspace{2mm} \begin{tikzpicture}[overlay]
    \begin{axis}[\shdateaxisticks clip=false, height=5.4cm, width=6.2cm,
        ...
        enlarge x limits={0.02}, tick label style={inner sep=0pt},]
    \rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40}, 
		yticklabel style={text width=1.0em}, tick label style={inner sep=0pt},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{100},\shdateaxisticks 
		...
		enlarge y limits={0.03}, tick label style={inner sep=0pt}, 
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ymin=15, ymax=492,
		...
		enlarge y limits={0.05}, tick label style={inner sep=0pt},
		yticklabel style={text width=1.5em},
		xticklabel={`\short{\year}}, clip=false]
	\rbars
...
\section*{\bcbox{red}Households} \index{households!overview}
\thispagestyle{sectpage}
\begin{minipage}{0.76\textwidth}
...
\end{minipage}
\newpage
\markright{\footnotesize \color{red}{\rule[0.5pt]{6.5pt}{6.5pt}} \color{black!90} \normalsize  \seriffont \ Households}
...
\small \textbf{Personal income}, or pre-tax income, \href{https://www.bea.gov/data/income-saving/personal-income}{includes} labor income (see\cbox{green!65!black}), measured as compensation of employees, capital income (see\cbox{orange!40!yellow}), measured as the sum of proprietor income, rental income, and dividend and interest income, and net government social benefits (see\cbox{blue!80!white}), measured as government social benefits less contributions to social insurance. 
\vspace{1mm}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	...
	\rbars
	\ctsbar{green!65!black}{date}{LABOR}{data/pi_levels.csv}{0.8pt}
	\ctsbar{orange!40!yellow!80!white}{date}{CAPITAL}{data/pi_levels.csv}{0.8pt}
	\ctsbar{blue!80!white}{date}{TRANSFER}{data/pi_levels.csv}{0.8pt}
	\node[right, align=left, shift=({rel axis cs:0.23,0.23}), fill=white, inner sep=0.5ex]
		{\small Labor Income};	
	\node[right, align=left, shift=({rel axis cs:0.34,0.59})]
		{\small Capital Income};	
	\node[right, align=left, shift=({rel axis cs:0.11,0.73})]
		{\small \color{blue!80!white} Net Government \\ \small \color{blue!80!white} Benefits};	
	\end{axis}
\end{tikzpicture}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	...
	\rbars
	\sbar{green!65!black}{date}{A033RC}{data/pi.csv}
...
\hspace*{-2mm} \begin{tikzpicture}
    ...
    x descriptions at=edge bottom, vertical sep=6pt,},]
    \nextgroupplot[\bbar{y}{0}, date coordinates in=x, axis line style={draw=black},
    	xticklabels=\empty, xtick style={draw=none}, 
		max space between ticks=20,	xmin={1989-01-01}, 
		tick label style={inner sep=0pt},
		enlarge y limits={0.32}, enlarge x limits={0.01},  
		yticklabel style={text width=1.6em},
		clip=false, height=5.0cm, width=12.4cm]
			\rbars
    ...
    \nextgroupplot[\bbar{y}{0}, \dateaxisticks 
		yticklabel style={text width=1.6em}, enlarge y limits={0.38}, 
		enlarge x limits={0.01}, xmin={1989-01-01}, max space between ticks=20,	
...
\begin{axis}[clip=false,
    xticklabels from table={\datatable}{pct}, xlabel={Decile},
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		...
		ymin=72, xticklabel style={align=center, yshift=-2pt}, 
		tick label style={inner sep=0pt}, clip=false, enlarge y limits=0.11,
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks enlarge y limits=0.22, ymax=470,
		max space between ticks=20, xticklabel style={align=center, yshift=-2pt}, 
		tick label style={inner sep=0pt},
		yticklabel style={text width=1.6em}, 
...
\end{minipage}
\newpage
\markright{\footnotesize \color{blue}{\rule[0.5pt]{6.5pt}{6.5pt}} \color{black!90} \normalsize  \seriffont \ Businesses} 
\begin{minipage}{0.33\textwidth}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=30,
		...
		tick label style={inner sep=0pt}, ymin=2, 
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10},
		xticklabel={`\short{\year}}, clip=false, height=4.5cm, ymax=8.8,
		reverse legend,
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10},
		xticklabel={`\short{\year}}, clip=false, height=4.5cm, reverse legend,
...
\hspace*{-3mm} \begin{tikzpicture} \pgfplotstableread[col sep=comma]{data/indprogr_rec.csv}\ipmo
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks max space between ticks=20,
		clip=false, width=6.7cm, height=4.4cm, 
		yticklabel style={text width=1.2em}, xtick=data, 
		xticklabels from table={\ipmo}{label}, 
		enlarge y limits=0.18, enlarge x limits=0.04] 
	\node[right, draw=black!30, fill=white] at (axis description cs: 0.0,1.02) 
		{\small \textbf{Market Group}};
	\ctsbar{violet!70!purple!90!black}{date}{Consumer goods}{\ipmo}{4pt} 
	\ctsbar{magenta}{date}{ENS}{\ipmo}{4pt} 
	\ctsbar{orange!75!yellow}{date}{Non-energy materials}{\ipmo}{4pt} 
	\ctsbar{blue!70!violet}{date}{Energy materials}{\ipmo}{4pt} 
	\end{axis}
\end{tikzpicture} \hfill 
\begin{tikzpicture} \pgfplotstableread[col sep=comma]{data/indprogr_rec.csv}\ipmo
	...
	height=4.4cm, xtick=data, xticklabels from table={\ipmo}{label},
	yticklabel style={text width=1.2em}, enlarge y limits=0.18, enlarge x limits=0.04] 
	\node[right, draw=black!30, fill=white] at (axis description cs: 0.0,1.02) 
		{\small \textbf{Industry Group}};
	\ctsbar{blue!62!black}{date}{Durable manufacturing}{\ipmo}{4pt} 
	\ctsbar{blue!20!cyan!80!white}{date}{Nondurable manufacturing}{\ipmo}{4pt} 
	\ctsbar{orange!30!yellow}{date}{Mining}{\ipmo}{4pt} 
	\ctsbar{green!70!blue}{date}{Electric and gas utilities}{\ipmo}{4pt}
	\end{axis} 
\end{tikzpicture}\\
...
\hspace{1mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks max space between ticks=30, 
		...
		xticklabel style={white, align=center, yshift=-2pt}, 
		tick label style={inner sep=0pt},
...
\hspace{1mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks max space between ticks=30, 
		ymin=0.02, ymax=3.5,
		clip=false, enlarge y limits={0.02}, 
		xticklabel style={white, align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		height=3.6cm, width=6.6cm, xticklabel={`\short{\year}}]
	\rbars
...
\begin{groupplot}[group style={group size=1 by 2, 
	...
	\nextgroupplot[\bbar{y}{100}, \dateaxisticks ytick={90, 100, 110, 120, 130}, 
		...
		xticklabel={`\short{\year}}, width=5.9cm, height=4.6cm,
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks tick label style={inner sep=0pt},
...
\small The \textbf{labor share} (see {\color{blue!60!cyan}\textbf{---}}) measures the portion of overall income that is paid to workers. In the national accounts, labor share can be measured as compensation of employees as a share of net domestic income (NDI). Net domestic income, or gross domestic income minus depreciation, is used instead of gross domestic income because depreciation expenses are paid to neither labor nor capital. 
\end{minipage}
\vspace{-3mm}

\begin{minipage}{0.41\textwidth} \index{labor share of income} \index{compensation of employees}
\normalsize \textbf{Labor Share of Income}\\
\footnotesize{\textit{gross labor income share of NDI, percent}}\\
\begin{tikzpicture}
	\begin{axis}[\shdateaxisticks max space between ticks=20, 
		enlarge y limits={0.36}, tick label style={inner sep=0pt},
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[clip=false,
            \barylab{0.5cm}{1.0ex}, stack negative=separate, ymajorgrids=false,
            ...
            bar width=1.2ex, reverse legend, xmajorgrids, 
            grid style={ultra thin, black!20},
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks max space between ticks=20,
		yticklabel style={text width=1.0em}, tick label style={inner sep=0pt},
		enlarge y limits={0.1}, ymin=0.9, ymax=18.4, 
		xticklabel style={align=center, yshift=-2pt}, 
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	...
	\nextgroupplot[\bbar{y}{0}, \shdateaxisticks ytick={0, 2, 4, 6, 8, 10, 12, 14, 16}, 
		width=9.2cm, height=5.6cm, enlarge x limits=0.01, tick label style={inner sep=0pt},
		xticklabel style={align=center, yshift=-2pt}, 
...
%\footnotesize{Notes: \color{magenta}{AHE}\color{black!90}: Average hourly earnings of employees on nonfarm payrolls; \color{blue}{WGT}\color{black!90}: Matched-observation median hourly earnings from Current Population Survey, three-month moving average; \color{cyan}{NIPA}\color{black!90}: Aggregate wages and salaries from national accounts divided by nonfarm payrolls, three-month moving average; \color{violet}{ECI}\color{black!90}: Employment cost index, quarterly}\\
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false, max space between ticks=15, 
		enlarge y limits={0.2}, tick label style={inner sep=0pt},
		xticklabel style={align=center, yshift=-2pt}, 
		xticklabel={`\short{\year}}, height=4.2cm, width=7.0cm]
	\rbars
...
\section*{\bcbox{orange}Financial Markets}
\vspace*{-3mm}
...
\hspace*{-3mm} \begin{tikzpicture}
	...
	\nextgroupplot[\bbar{y}{0}, \shdateaxisticks ytick={0, 1, 2, 3, 4, 5}, 
		enlarge y limits={value=0.16,upper}, ymin=0, yticklabel style={text width=1.2em}, 
    	tick label style={inner sep=0pt},
		height=4.3cm, width=8.2cm, clip=false, xmin={1989-01-01},
		xticklabels=\empty, xtick style={draw=none},]
	\rbars
	...
	\node[below, align=left, shift=({rel axis cs:0.13,0.98}),
	draw=black!30!white, fill=white, inner sep=3.0]
		{\small \color{black!80!white} \textbf{S\&P 500}};
	\nextgroupplot[\ltdateaxisticks ytick={2, 3, 4, 5}, 
		enlarge y limits={0.18}, 
		height=4.3cm, width=5.8cm, clip=false, tick label style={inner sep=0pt},
		xticklabels=\empty, xtick style={draw=none}]
	\rbar
	...
	\absnodeml{{2021-01-01}}{3.35}{\scriptsize 
		\color{black!40!white}\textbf{One-year moving average}}{1.3}
	\nextgroupplot[\bbar{y}{0}, \shdateaxisticks 
		enlarge y limits={value=0.16,upper}, ymin=0, yticklabel style={text width=1.2em}, 
    	tick label style={inner sep=0pt}, height=4.3cm, width=8.2cm, 
    	clip=false, xmin={1989-01-01},
		xticklabels=\empty, xtick style={draw=none}]
	\rbars
	...
	\node[below, align=left, shift=({rel axis cs:0.12,0.98}), fill=white, 
	draw=black!30!white, inner sep=3.0]
		{\small \color{black!80!white}\textbf{Nasdaq}};
	\nextgroupplot[\ltdateaxisticks 
		enlarge y limits={0.18}, 
		yticklabel style={text width=1.0em}, 
    	tick label style={inner sep=0pt},
		height=4.3cm, width=5.8cm, clip=false, 
		xticklabels=\empty, xtick style={draw=none}]
	\rbar
	...
	\nextgroupplot[\bbar{y}{0}, \shdateaxisticks 
		...
		height=4.3cm, width=8.2cm, clip=false, tick label style={inner sep=0pt},
		xticklabels=\empty, xtick style={draw=none}]
	\rbars
	...
	\node[below, align=left, shift=({rel axis cs:0.12,0.98}), fill=white, inner sep=3.0,
		draw=black!30!white]
		{\small \color{black!80!white}\textbf{Dow 30}};
	\nextgroupplot[\ltdateaxisticks 
		enlarge y limits={0.18}, 
		yticklabel style={text width=1.0em}, 
    	tick label style={inner sep=0pt}, height=4.3cm, width=5.8cm, clip=false, 
		xticklabels=\empty, xtick style={draw=none}]
	\rbar
	...
	\nextgroupplot[\bbar{y}{0}, \shdateaxisticks 
		...
		xticklabel={`\short{\year}}, height=4.1cm, width=8.2cm, clip=false]
	\rbars
	...
	\node[below, align=left, shift=({rel axis cs:0.18,0.98}), fill=white, inner sep=3.0,
		draw=black!30!white]
		{\small \color{black!80!white}\textbf{Russell 3000}};
	\nextgroupplot[\ltdateaxisticks 
		enlarge y limits={0.18}, 
		yticklabel style={text width=1.2em}, 
		xticklabel={`\short{\year}}, height=4.3cm, width=5.8cm, clip=false]
	\rbar
...
\end{minipage}
\newpage
\markright{\footnotesize \color{orange}{\rule[0.5pt]{6.5pt}{6.5pt}} \color{black!90} \normalsize  \seriffont \ Financial Markets}
\vspace*{-9mm}

\begin{minipage}{0.76\textwidth}
\index{equity markets}
\small The \href{https://us.spindices.com/indices/equity/sp-500}{S\&P 500} (see {\color{green!80!blue!90!black}\textbf{---}}) is a market-cap-weighted stock market index based on 500 large companies listed on US exchanges. \input{text/eq_sp500.txt} The \href{https://www.nasdaq.com/market-activity/index/comp}{Nasdaq} composite index (see {\color{blue}\textbf{---}}) includes nearly all companies listed on the Nasdaq stock exchange, and is heavily-weighted towards large tech companies. \input{text/eq_nasdaq.txt}

The \href{https://finance.yahoo.com/quote/\%5EDJI/}{Dow Jones} (see {\color{red}\textbf{---}})  industrial average is an index based on 30 large and prominent companies listed on US exchanges. The measure is used as a proxy for the performance of the largest companies, and \input{text/eq_dow.txt} Lastly, the \href{https://www.ftserussell.com/products/indices/russell-us}{Russell 3000} (see {\color{violet}\textbf{---}}) is a broad measure of the US stock market that seeks to be a benchmark of the performance of the overall market. \input{text/eq_russell.txt}
...
\hspace{2mm} \begin{tikzpicture}[overlay]
    ...
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={-2, -1, 0, 1, 2, 3}, 
    	ymin=-2.2, ymax=3.1,
    	yticklabel style={text width=1.0em}, 
     xticklabel={`\short{\year}},  height=5.4cm, width=6.1cm, clip=false]
    \rbar
...
\end{minipage}
\newpage
\markright{\footnotesize \color{purple}{\rule[0.5pt]{6.5pt}{6.5pt}} \color{black!90} \normalsize  \seriffont \ Prices}
...
\hspace{1mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		...
		width=12.5cm, height=4.7cm, ymin=0.2,
		xticklabel={`\short{\year}}, clip=false]
	\rebars
