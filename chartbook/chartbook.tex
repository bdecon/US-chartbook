...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rebars
	\stdnode{3.75cm}{1.3cm}{\footnotesize \color{orange!80!white}Government}
	...
	\stdnode{1.4cm}{2.05cm}{\footnotesize \color{red!90!white}FIRE+}
	\stdline{red!90!white}{date}{FIRE}{data/gdpva_pc.csv}
	\stdnode{3.25cm}{4.25cm}{\footnotesize \color{purple!70!blue}Goods + TTU}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.7cm}{0.3cm}{\footnotesize \color{blue!80!black}Black}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\stdnode{4.0cm}{2.5cm}{\footnotesize \color{red}Goods}
	\stdline{red}{date}{Goods}{data/pce_levels.csv}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.3cm}{1.45cm}{\footnotesize \color{green!80!blue!85!black}Middle 20}
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10, 15, 20, 25}, 
		...
		legend style={legend columns=2, at={(0.57, 1.05)}, fill=white}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{2.2cm}{1.3cm}{\footnotesize \color{green!80!blue}Exports}
	\stdnode{0.9cm}{2.9cm}{\footnotesize \color{blue!80!violet}Imports}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.0cm}{3.8cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
	\stdnode{3.1cm}{0.75cm}{\footnotesize \color{green!90!blue}State}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{2.3cm}{1.8cm}{\scriptsize \color{blue!70!black}\textbf{Market}}
	\stdnode{2.8cm}{3.6cm}{\scriptsize \color{violet!60!magenta}\textbf{Survey}}
	\end{axis}
\end{tikzpicture}\\
