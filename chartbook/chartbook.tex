...
\noindent \begin{tikzpicture}
    \begin{axis}[\shdateaxisticks clip=false, height=5.0cm, width=5.9cm,
        xticklabel={`\short{\year}}, enlarge y limits={lower, 0.2}, 
...
The US population is increasing (see {\color{lime!90!green}\textbf{---}}), though at a slower rate than in the past. Over the past 30 years, the US has added 80 million people, a total population growth rate of around 30 percent. This means the amount of goods and services produced needed to increase by 30 percent over the period to maintain a constant standard of living. 

The employment rate (see {\color{green!30!teal!90!black}\textbf{---}}) neared 50 percent during the peak of recent economic expansions as a tighter labor market and higher wages pull people into employment, and falls during a recession as people lose jobs. 

The average hours worked per worker per week (see {\color{blue}\textbf{---}}) are also influenced by economic conditions. During an economic expansion, more hours of work are available to those who want them. During a recession and when demand for goods and services is relatively low, hours of work are cut.
\end{minipage}
\vspace{2mm}
...
\begin{minipage}{0.76\textwidth}
\small Total hours of work can be estimated by multiplying the population, employment rate, and average hours worked. Labor productivity is then estimated as GDP per hour of work (see {\color{cyan!60!white}\textbf{---}}). During a recession, when GDP falls, economic theory suggests that productivity increases, in the short-run, as less-productive workers disproportionately lose jobs: less-productive firms close and existing firms lay off less-productive workers.
\end{minipage}
...
\small Annual data on personal income \href{https://www.census.gov/data/tables/time-series/demo/income-poverty/cps-pinc/pinc-09.html}{describe} the number of people receiving various categories of income and the average payment. As a result, it is possible to match changes in aggregate personal income from changes in payment amounts (see\cbox{blue!60!cyan}) and changes in who is receiving payments (see\cbox{green!90!blue}). 
...
\hspace{40mm} \begin{tikzpicture}[overlay]
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{4.2cm}{1.5ex}
    	width=9.2cm, bar width=2.0ex, height=6.0cm,
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30}, enlarge y limits={0.01},
		...
		xticklabel={`\short{\year}}, height=5.1cm, width=12.0cm, clip=false]
	\rbars
...
\newpage
\begin{minipage}{0.76\textwidth}
\small Trends in \textbf{household debt} over the past three years, measured in both the US Financial Accounts and the New York Fed Consumer Credit Panel, show mortgages growing in line with income while consumer credit debt falls relative to income. Minor discrepancies between the two data sources arise because the Financial Accounts include debt of nonprofit institutions and the Consumer Credit Panel does not include people without a social security number.
...
\hspace{4mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 100, 200, 300, 400, 500},
		 ymin=20, height=5.2cm, reverse legend, 	
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10, 15, 20, 25}, 
		height=6.2cm, enlarge y limits={0.02}, 
		xticklabel={`\short{\year}}, yticklabel style={text width=1.4em},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false,
		ymin=0.6, xticklabel={`\short{\year}}, height=6.6cm, width=6.2cm]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\dateaxisticks ytick={500, 1000, 1500}, 
		...
		xticklabel={`\short{\year}}, width=12.4cm]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 200, 400, 600, 800, 1000}, 
		...
		xticklabel={`\short{\year}}, height=4.6cm, width=12.4cm]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\dbar{y}{100}, \shdateaxisticks
		xticklabel={`\short{\year}}, clip=false, height=5.8cm, width=7.4cm, 
		yticklabel style={text width=1.2em}]
	\rbars
...
\hspace*{-3mm} \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{2.0pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.55}
\begin{tabular}{p{38mm} R{12mm} R{12mm} R{12mm} R{12mm}
		 		 R{12mm} R{12mm}}
			 \input data/nha.tex \hline
		\end{tabular}}}

\vspace{-2mm}		
\footnotesize{Source: Author's Calculations, Census Bureau, Freddie Mac, CPS}
\end{minipage}
\newpage
...
\footnotesize{\textit{millions of people}}\\
  \hspace*{-4mm} \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[green!85!blue] coordinates {(29.8, 0)};
      \addplot[blue] coordinates {(82.5, 1)};
    \end{axis}
  \end{tikzpicture}\\
...
\normalsize \textbf{Poverty Measures, 2020}\vspace{-1mm}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{0.5cm}{4.1cm}{\large 2020}
	\end{axis}
\end{tikzpicture}
\hfill
\begin{tikzpicture}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks width=12.2cm, 
		...
		height=6.6cm, clip=false, xticklabel={`\short{\year}}]
	\rbars
...
\begin{axis}[\bbar{y}{100}, \shdateaxisticks %ytick={90, 100, 110, 120}, 
		yticklabel style={text width=1.5em}, enlarge y limits={0.1},
		xticklabel={`\short{\year}}, width=7.5cm, height=3.9cm,
		clip=false]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[ymin=0, ymax=100, xmin=0, xmax=80, 
		yticklabel style={text width=1.5em},
		width=12.6cm, height=10.0cm, xlabel={Age}]
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, height=6.8cm, width=12.6cm, xmin=0, xmax=80, 
		enlarge y limits={0.09}, xlabel={Age}, axis line style={draw=none},
		yticklabel style={text width=1.5em},
		legend style={legend columns=1, at={(0.28, 0.99)}, reverse legend,
		legend cell align={left}}]
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20}, 
		...
		xticklabel={`\short{\year}}, height=4.2cm, width=7.1cm, clip=false]
	\rbars
...
\hspace*{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 5, 10, 15, 20}, 
		enlarge y limits={0.1}, yticklabel style={text width=1.0em},
		xticklabel={`\short{\year}}, clip=false, height=4.8cm, ymin=1.4, ymax=17,
...
\hspace*{-3mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{1.8cm}{1.5ex}
    	width=3.6cm, bar width=1.8ex, height=5.6cm,
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=7.0cm, width=7.0cm,	xmajorgrids, ymax=6.6,
...
\normalsize \textbf{Steel \hspace{5.6cm} Lumber}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{1}, \shdateaxisticks ytick={0, 1, 2, 3, 4, 5, 6, 7}, 
		...
		xticklabel={`\short{\year}}, height=5.0cm, width=6.6cm, clip=false]
	\rbars
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		...
		yticklabel style={text width=1.2em}, width=12.2cm, height=4.6cm, ymin=0.8,
		xticklabel={`\short{\year}}, clip=false]
	\rebars
