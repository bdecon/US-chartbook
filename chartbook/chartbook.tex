...
\small Text here to describe the charts below. Probably will move this to a new page, because need to describe these charts with some background.\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{2.0cm}{1.5ex}
    	width=5.0cm, bar width=2.0ex, height=6.2cm, xmin=0.5,
...
\footnotesize{\textit{Change from November 2019 to November 2018, thousands of people, not seasonally adjusted}}\\
