...
\small \textit{Open source notes on US economic activity}
...
This chartbook is an early draft; please report errors by email or through GitHub. 
\vfill
...
As a result of these shortcuts, it is unlikely that you will be completely satisfied with the content of the chartbook. Therefore, I offer the content in combination with links to the data and \href{https://github.com/bdecon/US-chartbook}{source code}. Hopefully the end-result can inspire and facilitate your own examination of topics of interest or relevance.
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30, 40, 50, 60}, ymin=2.5,
		xticklabel={`\short{\year}}, clip=false, yticklabel style={text width=1.4em}, 
...
\small The \textbf{mortgage rate} \href{https://www.freddiemac.com/pmms/pmms30}{available} to homebuyers can affect housing markets, which in turn can affect demand for other consumer goods. \input{text/mortgage.txt} 
\vspace{0.5mm} 
