...
\footnotesize{\textit{not seasonally adjusted}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={0, 1000, 2000, 3000, 4000, 5000, 6000}, 
		enlarge y limits={0.05}, ymin=250, xmin={2018-01-01},
		xticklabel={`\short{\year}}, height=6.6cm, width=6.2cm]
	\rbars
...
\footnotesize{\textit{insured unemployed, in thousands,}}\\
\footnotesize{\textit{not seasonally adjusted}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={0, 5000, 10000, 15000, 20000}, 
		enlarge y limits={0.05}, ymin=250, xmin={2018-01-01},
		xticklabel={`\short{\year}}, height=6.6cm, width=6.2cm]
	\rbars
...
\end{minipage}\hspace{6mm} \begin{minipage}{0.32\textwidth}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: BLS} \hspace{27mm} \tbllink{hours.csv}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 2, 4, 6, 8, 10}, 
		xticklabel={`\short{\year}}, clip=false, ymin=0.5, width=7.4cm]
	\rbars
