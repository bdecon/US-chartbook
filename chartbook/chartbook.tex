...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={14, 15, 16, 17, 18, 19}, 
		enlarge y limits={0.1},
		xticklabel={`\short{\year}}, height=4.4cm, width=7.0cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={45, 50, 55, 60, 65, 70}, 
		...
		yticklabel style={text width=1.5em}, height=4.4cm, 
		width=7.1cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-10, -5, 0, 5, 10}, 
		...
		xticklabel={`\short{\year}}, width=12.0cm]
	\rebars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={400, 600, 800, 1000, 1200, 1400}, 
		xticklabel={`\short{\year}}, clip=false, width=11.8cm, 
		yticklabel style={text width=2.2em}]
	\rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-20, -10, 0, 10, 20}, 
		xticklabel={`\short{\year}}, yticklabel style={text width=1.5em},
		width=11.3cm, height=5.0cm, clip=false]
	\rebars
	...
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Census Bureau} \hspace{74mm} \tbllink{marts.csv}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={8, 9, 10}, clip=false, 
		xticklabel={`\short{\year}}, height=5.1cm, width=8.1cm, 
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.1cm}{0.4cm}{\footnotesize \color{green!75!blue}Median}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={6, 8}, clip=false,
		xticklabel={`\short{\year}}, height=5.8cm, width=7.0cm]
	\rebars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 0.5, 1.0, 1.5}, 
		...
		xticklabel={`\short{\year}}, height=6.0cm, width=12.3cm, clip=false]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15, 20, 25, 30}, 
		xticklabel={`\short{\year}}, clip=false, width=12.6cm, height=5.6cm]
	\rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\dateaxisticks ytick={-20, -10,  0, 10, 20}, 
		...
		yticklabel style={text width=1.35em},
		xmin = {1989-01-01},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks ytick={0, 1.0, 2.0, 3.0}, 
		...
		xticklabel={`\short{\year}}, height=5.9cm, width=6.6cm]
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 500, 1000, 1500, 2000}, 
		xticklabel={`\short{\year}}, ymin=60, width=7.6cm]
	\rbars
