...
Contact: \textbf{Brian Dew} \ {\color{gray} \faEnvelope} brian.w.dew@gmail.com \ 
...
\subsection*{\color{black!70} {\seriffont Proposed Contents:}}
...
\begin{minipage}{0.76\textwidth}
\subsection*{\color{black!70} \seriffont Consumer Spending}
...
When businesses invest in ways that make workers more productive, the economy is able to meet more material needs with the same inputs. Business investment is grouped by structures (see\cbox{yellow!50!orange}), equipment (see\cbox{cyan!60!white}), and intellectual property products (see\cbox{violet}). 
\vspace{5mm}
