...
\footnotesize{\textit{per capita, thousands of 2020 Q1 dollars}}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{8.8cm}{1.5cm}{\scriptsize \color{blue!40!cyan}\textbf{Manufacturing}}
	\stdnode{7.7cm}{2.3cm}{\scriptsize \color{blue!80!black}\textbf{Total index}}
	\end{axis}
\end{tikzpicture}
...
\small The \textbf{current account balance} can be decomposed into the balance on trade in goods (see\cbox{yellow!60!lime!85!white}), the balance on trade in services (see\cbox{cyan!50!white}), the balance on primary income (such as wages or income from assets [see\cbox{blue!80!cyan}]), and secondary income (such as remittances and taxes [see\cbox{green!80!blue}]). \input{text/cab.txt} 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 1, 2, 3}, 
		enlarge y limits={0.1},
		xticklabel={`\short{\year}}, height=4.8cm, width=6.4cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50}, 
		...
		xticklabel={`\short{\year}}, height=4.8cm, width=6.3cm, clip=false]
	\rbars
	\stdline{green!75!blue}{date}{Median}{data/unempdur.csv}
	\stdline{orange}{date}{Mean}{data/unempdur.csv}
	\stdnode{3.9cm}{0.4cm}{\footnotesize \color{green!75!blue}Median}
	\stdnode{1.1cm}{1.7cm}{\footnotesize \color{orange}Average}
	\end{axis}
\end{tikzpicture}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={0, 1, 2, 3, 4, 5, 6}, 
		...
		xticklabel={`\short{\year}}, height=6.7cm, width=6.3cm]
	\rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 0.5, 1.0, 1.5}, 
		...
		xticklabel={`\short{\year}}, height=5.6cm, width=12.3cm, clip=false]
	\rebars
...
\small Matching wage observations one year apart makes it possible to track how many people do not receive a wage increase. The Atlanta Fed measures this as the share of individuals who have one-year wage growth of between -0.5 and 0.5 percent.
