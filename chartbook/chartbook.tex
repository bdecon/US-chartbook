...
\noindent \hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-2, 0, 2, 4, 6, 8}, xmin = 1989-01-01,
		xticklabel={`\short{\year}}, yticklabel style={text width=1.5em}, clip=false, 
		legend style={at={(0.95, 1.13)}}]
	\rbars
...
More text here about contributions to industrial production growth from broad categories. Include more than just the three in the chart, by including manufacturing, utilities, and mining. Focus on three year change and one year change. Probably best to let the program decide which series to highlight, since space is limited.\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={60, 80, 100}, 
		...
		minor xtick={}, 
        xticklabels={`89, `95, `00, `05, `10, `15, `19 Oct},
		clip=false, height=5.8cm, width=7.4cm,
		legend style={fill=white, legend columns=1, at={(1.02, 0.32)}}]
	\rbars
	\thickline{cyan!50!white}{date}{Manufacturing}{data/indpro.csv}
	\stdline{blue!90!violet}{date}{Total index}{data/indpro.csv}
...
\small Industrial activity is measured both by market group and by industry group.\\

\vspace{1mm}

\noindent \normalsize \textbf{Industrial Production Growth, Market Group}\\
\footnotesize{\textit{percentage point contribution to quarterly growth at seasonally adjust annual rate}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
...
\small Market group data show a long-term slowdown, while industry group data show a change in the composition of industrial activity.\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\sbar{green!80!blue}{date}{Utilities}{data/indprogr2.csv}
...
\small Recent data show that the slowdown has been concentrated in X industry and X market group. The monthly data are shown in detail below.\\
...
\begin{tikzpicture}
	...
	\sbar{blue!20!cyan!80!white}{date}{Nondurable manufacturing}{data/indprogr_rec2.csv}
	\sbar{orange!20!yellow}{date}{Mining}{data/indprogr_rec2.csv}
	\sbar{green!80!blue}{date}{Utilities}{data/indprogr_rec2.csv}
	\end{axis}
\end{tikzpicture}
\\
\footnotesize{Source: Federal Reserve} \\
