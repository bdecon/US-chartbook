...
\index{gross domestic product!household inputs}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-30, -20, -10, 0, 10, 20, 30}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=6.1cm]
	\rbars
...
\begin{tikzpicture}
    ...
    \nextgroupplot[\bbar{y}{0}, \shdateaxisticks 
		...
		ytick={-4, -2, 0, 2, 4, 6, 8},
		xticklabel={\year}, clip=false, height=4.3cm, width=9.6cm]
	\rbars
	\ctsbar{red!95!black}{date}{A191RL}{data/gdp_a.csv}{6.6pt}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20, 
		...
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		clip=false, width=12.7cm, height=6.2cm, 
...
\hspace{6mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\dateaxisticks enlarge y limits={0.18}, 
		yticklabel style={text width=2.2em},
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, clip=false, height=8.2cm, width=12.0cm]
	\rbars
	...
	\stdnode{1.6cm}{5.0cm}{\footnotesize \color{green!80!blue}Bachelor or \\\footnotesize \color{green!80!blue}Advanced\\\footnotesize \color{green!80!blue}Degree}
	\stdnode{4.6cm}{1.3cm}{\footnotesize \color{cyan}Some College}
	\stdnode{7.3cm}{2.6cm}{\footnotesize \color{orange!80!yellow!85!red}Total,\\\footnotesize \color{orange!80!yellow!85!red}Any Education}
