...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{3.3cm}{2.1cm}{\scriptsize \color{cyan}\textbf{Hires}}
	\stdnode{5.0cm}{3.1cm}{\scriptsize \color{blue!80!black}\textbf{Openings}}
	\stdnode{4.9cm}{1.45cm}{\scriptsize \color{red!85!violet}\textbf{Quits}}
	\stdnode{1.5cm}{0.55cm}{\scriptsize \color{orange!70!yellow}\textbf{Layoffs}}
	\end{axis}
\end{tikzpicture}\\
