...
\begin{minipage}{0.76\textwidth} 
\small The share of the US population that is employed in a given occupational group has shifted drastically as a result of the COVID-19 pandemic. Additionally, some full-time workers became part-time and some part-time workers became full-time. During the past three months, which end \input{text/cps_lfs_date.txt}\unskip, the share of people employed full-time decreased in most occupational groups compared to the same three months one year prior.
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{5.9cm}{0.35cm}{\footnotesize \color{blue!50!purple!80!black}PUA}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{6.02cm}{1.5cm}{\footnotesize \color{green!50!blue}PUA+\\ \footnotesize \color{green!50!blue}PEUC}
