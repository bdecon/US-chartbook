...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30}, enlarge y limits={0.01},
		...
		xticklabel={`\short{\year}}, height=5.4cm, width=12.1cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={-100, -50, 0, 50, 100, 150, 200, 250, 300}, 
		...
		height=7.3cm, width=6.8cm, clip=false]
	\rbars
	...
	\stdnode{4.3cm}{2.1cm}{\footnotesize \color{red!80!black}60-80}
	\stdnode{4.2cm}{1.5cm}{\footnotesize \color{green!80!blue!85!black}Middle 20}
...
\small The bottom quintile, or fifth of households, by total money income, are estimated to dissave in \input{text/ce_year.txt}\unskip, equivalent to more than a third of a median salary (see {\color{violet}\textbf{---}}). This is a combination of people going into debt and retirees dissaving. Households in the top 20 percent of the population by income save more than two typical incomes, on average in \input{text/ce_year.txt} (see {\color{blue!80!cyan!80!black}\textbf{---}}). 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 2, 4, 6, 8, 10, 12, 14, 16}, 
		...
		height=5.6cm, ymin=0.7, legend cell align={left}, reverse legend,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-2, -1, 0, 1, 2, 3, 4}, 
		xticklabel={`\short{\year}}, height=5.8cm, width=12.1cm, clip=false]
	\recbars
	\stdline{red}{date}{Ten-year}{data/real_rates.csv}
	\stdline{violet}{date}{Five-year}{data/real_rates.csv}
	\absnode{{2004-05-01}}{0.8}{\footnotesize \color{violet}\textbf{Five-year}}
	\absnode{{2009-10-01}}{2.1}{\footnotesize \color{red}\textbf{Ten-year}}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=7.0cm, width=7.0cm,	xmajorgrids,
...
\hspace*{-2mm} \begin{tikzpicture}
    ...
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={0, 1, 2, 3}, 
		enlarge y limits={0.1}, ymin=-0.65, ymax=2.3, enlarge y limits={0.02},  
		xticklabel={`\short{\year}}, height=5.6cm, width=6.2cm, clip=false]
    \rbar
	\thinline{blue}{date}{Ten-3M}{data/spread.csv}
	\node[text width=3.8cm, anchor=west] at (axis description cs: 0, 0.95) 
		{\small \color{blue}\textbf{10-Year - 3-Month}};
	\input{text/spread_node.txt}
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={0, 1, 2, 3}, 
		enlarge y limits={0.1}, ymin=-0.65, ymax=2.3, enlarge y limits={0.02}, 
		xticklabel={`\short{\year}}, height=5.6cm, width=6.2cm, clip=false]
	\rbar
	\thinline{red!90!black}{date}{Ten-2Y}{data/spread.csv}
	\node[text width=3.8cm, anchor=west] at (axis description cs: 0, 0.95) 
		{\small \color{red!90!black}\textbf{10-Year - 2-Year}};
