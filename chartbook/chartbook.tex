...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60},
		xticklabel={`\short{\year}}, clip=false, ymin=3,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30}, enlarge y limits={0.1},
		xticklabel={`\short{\year}}, height=4.8cm, width=12.3cm, clip=false]
	\rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{6.25cm}{1.9cm}{\scriptsize \color{green!90!blue}\textbf{Total}}
	\stdnode{7.8cm}{2.85cm}{\scriptsize \color{blue!70!black}\textbf{Nonstore}}
	\end{axis}
\end{tikzpicture}\\
...
\hspace{3.4cm} \begin{tikzpicture}[overlay]
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{3.7cm}{1.5ex}
    	width=4.8cm, bar width=1.7ex, height=9.8cm,
    	enlarge y limits={abs=0.35cm}, enlarge x limits=0.12, \bbar{x}{0},
		yticklabels from table={\rs}{name}, 
		yticklabel style={font=\footnotesize},
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=2, assume math mode},
		legend style={text=black!70, at={(1.1,1.12)}, legend columns=1, 
				fill=none, draw=none}]
	\addplot[fill=teal!50!green, draw=none] 
 	...
 	\legend{\input{text/rs_mon2.txt}, \input{text/rs_mon1.txt}}
  	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Census, BEA} \hspace{38mm} \tbllink{rs_comp.csv}
...
\noindent \normalsize \textbf{US Trade in Goods} \hspace{12mm} \input{text/trade_date.txt} \hspace{18mm} \input{text/trade_date2.txt}\\
\footnotesize{\textit{census basis, millions of USD,}}\\
\footnotesize{\textit{not seasonally adjusted}}\\

\vspace{-3mm}

\noindent \hspace*{-3mm} \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{3.0pt} \color{black!90}
		{\renewcommand{\arraystretch}{1.54}
...
\footnotesize{\textit{share of GDP, percent}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={50, 100, 150, 200}, enlarge y limits={0.1},
		xticklabel={`\short{\year}}, clip=false, height=5.0cm,
		legend style={legend columns=1, at={(0.28, 0.9)}, fill=white}, fill between/on layer={main}]
	\rbars
