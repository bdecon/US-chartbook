...
%
	...
	\newcommand{\lfdateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmin={2018-01-01}, xmax={2023-07-31},   
	...
	\newcommand{\tydateaxisticks}{
		date coordinates in=x, axis line style={draw=none},
		xmax={2023-07-31}, max space between ticks=40,	    
...
%
\textbf{Version 0.1 release planned for Summer 2023}
\end{minipage}
\newpage
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{3.8cm}{0.3cm}{\footnotesize \color{violet}Indirect Taxes}
...
\footnotesize{\textit{GDP per hour of work, index, 2000=100}}\\
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={60, 70, 80, 90, 100, 110, 120, 
	130, 140, 150, 160}, 
		yticklabel style={text width=1.0em}, 
		enlarge y limits={0.1}, 
		xticklabel={`\short{\year}}, height=7.0cm, width=6.9cm, clip=false]
	\rbars
	\thinline{violet}{date}{LPROD_BLS_idx}{data/gdpjobslvl.csv}
	\absnode{{2009-07-01}}{157}{\footnotesize \color{violet}Nonfarm\\ \color{violet}Businesses}
	\thickline{cyan!70!white}{date}{LPROD_idx}{data/gdpjobslvl.csv}
	\absnode{{2010-10-01}}{122}{\footnotesize \color{cyan!70!white}\textbf{Total}\\ \footnotesize \color{cyan!70!white}\textbf{Economy}}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: BLS, Author's Calculations} \hfill \tbllink{gdpjobslvl.csv} 
\end{minipage}
\vspace{4mm}

\begin{minipage}{0.76\textwidth}
\normalsize \textbf{Household Inputs to Production}\\
\footnotesize{\textit{index, January 2000=100}}
\vspace{-5mm}

\hspace*{-2mm} \rowcolors{1}{}{black!5} \setlength{\tabcolsep}{2pt} \color{black!90}
{\renewcommand{\arraystretch}{1.6}
	\begin{tabular}{p{39mm} R{9.8mm} R{9.8mm} R{9.8mm} R{9.8mm} R{9.8mm} 
	 R{9.8mm} R{9.8mm}} 
		\input data/gdpjobs.tex \hline 
	\end{tabular}}
	\vspace{-2.5mm}
				
\footnotesize{Source: Bureau of Economic Analysis and Author's Calculations} \hfill \tbllink{gdpjobslvl.csv}
\end{minipage}
\newpage
...
\begin{minipage}{0.76\textwidth}
\subsection*{Investment} \index{investment!overview} \index{investment!fixed investment} \index{investment!inventory investment} \index{inventories}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{3.0cm}{6.5cm}{\footnotesize \color{blue!60!violet}Gross Investment}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{2011-10-01}}{1550}{\footnotesize \color{green!90!black}\textbf{Residential}}
...
\footnotesize{\textit{millions of US dollars, seasonally adjusted \hspace{40mm} quarterly average}\\
...
\newpage
\begin{minipage}{0.43\textwidth} \index{labor share of income} \index{compensation of employees}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=7.2cm, width=7.7cm,	xmajorgrids, ymax=8.4, ymin=0.35,
