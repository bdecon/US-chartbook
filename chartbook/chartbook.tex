...
\noindent \hspace*{-2mm} \begin{tikzpicture}
  	...
  	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: CPS ASEC} \hspace{33mm} \tbllink{poor.csv}
\end{minipage}\hspace{6mm}
\begin{minipage}{0.45\textwidth}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
  	...
  	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: CPS ASEC} \hspace{33mm} \tbllink{poor2.csv}
\end{minipage}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\draw [black!25!white, dashed] ({2016-12-01},2000) rectangle ({2020-06-17},3500);
...
\begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks ytick={2000, 2500, 3000, 3500, 4000}, 
		enlarge y limits={0.1}, xmax={2020-05-03},
		xticklabel={`\short{\year}}, height=5.6cm, width=6.6cm, clip=false]
