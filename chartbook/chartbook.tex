...
\section*{Financial Accounts} \markright{\seriffont Financial Accounts}
...
\begin{axis}[clip=false,
    ...
    enlarge x limits={0.18}, enlarge y limits={0.2, upper}, nodes near coords, 
    nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=1, assume math mode},
...
\hspace*{-1.5mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
		...
		enlarge y limits={0.01}, xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15}, 
		height=8.5cm, width=6.7cm, xmin={1989-12-01}, clip=false,
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.85cm}{1.1cm}{\footnotesize \color{yellow!50!orange} Structures}
	\stdnode{4.6cm}{2.9cm}{\footnotesize \color{cyan!60!white} Equipment}
	\stdnode{1.25cm}{2.1cm}{\footnotesize \color{violet} Intellectual \\ \footnotesize \color{violet} Property}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\rebars
	\stdnode{1.7cm}{1.85cm}{\footnotesize \color{blue!70!white}Federal}
	\stdline{blue!70!white}{date}{Federal}{data/gdpva_pc.csv}
	\stdnode{3.6cm}{3.3cm}{\footnotesize \color{red}State and Local}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ymin=0.8, 
		...
		xticklabel={`\short{\year}}, clip=false, height=5.6cm, width=7.0cm]
	\rbars
	\stdnode{4.0cm}{3.3cm}{\footnotesize \color{violet}Gov. Social \\ \footnotesize \color{violet}Benefits}
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{1.2cm}{2.3cm}{\footnotesize \color{blue!60!black}National \\ \footnotesize \color{blue!60!black}Defense}
...
\hspace{3mm} \begin{tikzpicture}[overlay]
	...
	\node[below, align=left, shift=({rel axis cs:0.78,0.91})]
	...
	\node[below, align=left, shift=({rel axis cs:0.26,0.59})]
...
\begin{minipage}{0.34\textwidth} \index{employment!overview} \index{labor force participation}
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20}, 
		...
		xticklabel={`\short{\year}}, height=4.7cm, width=7.8cm, clip=false]
	\rbars
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	...
	\node[right, align=left, shift=({rel axis cs:0.02,0.94}), 
	draw=black!30!white, fill=white, inner sep=5.0]
		{\normalsize \color{black!80!white}\textbf{Age 19 to 21}};
	\end{axis}
\end{tikzpicture}
\hspace{6.2cm}
\begin{tikzpicture}[overlay]
	...
	\node[right, align=left, shift=({rel axis cs:0.02,0.94}), 
	draw=black!30!white, fill=white, inner sep=5.0]
		{\normalsize \color{black!80!white}\textbf{Age 22 to 24}};
	\end{axis}
\end{tikzpicture}
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\dateaxisticks 
		enlarge y limits={0.28}, clip=false, legend cell align={left},
		legend style={at={(0.38, 0.32)}}, legend columns=1, 
		xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
		xticklabel={`\short{\year}}, height=5.8cm, width=12.7cm]
	\rebars
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	...
	draw=black!30!white, fill=white, inner sep=3.5]
		{\normalsize \color{black!80!white}\textbf{Hourly}};
	\end{axis}
...
\begin{tikzpicture}[overlay]
	...
	draw=black!30!white, fill=white, inner sep=3.5]
		{\normalsize \color{black!80!white}\textbf{Weekly}};
	\legend{Real, Nominal};
	\end{axis}
\end{tikzpicture}
...
\begin{minipage}{0.43\textwidth} \index{yield curve}
\vspace{-2.5mm}
...
\hspace*{-2mm} \begin{tikzpicture}[trim axis right]
	\begin{axis}[height=6.2cm, width=8.0cm, xmajorgrids, ymin=0.7,
		...
		reverse legend, xticklabel style={black, font=\small}, 
...
\hspace*{-3mm} \begin{tikzpicture}
    ...
    \nextgroupplot[\bbar{y}{0}, \ltdateaxisticks ytick={-2, -1, 0, 1, 2, 3}, 
    	...
    	yticklabel style={text width=1.0em}, 
    	xticklabel style={align=center, yshift=-2pt}, tick label style={inner sep=0pt},
     xticklabel={`\short{\year}},  height=5.9cm, width=6.1cm, clip=false]
    \rbar
...
\end{minipage}
\newpage 
\hypertarget{pr}{\label{pr}} \markright{\seriffont Prices} \index{prices!consumer price index}
\begin{minipage}{0.76\textwidth} 
\section*{Prices}
\vspace*{-2mm}
...
\end{minipage}
\newpage
\markright{\seriffont Acknowledgments}
\begin{minipage}{0.76\textwidth}
