...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 500, 1000, 2000, 3000}, enlarge y limits={0.1},
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={1, 2, 3, 4, 5}, 
		enlarge y limits={0.1}, xmax={2020-04-01},
		xticklabel={`\short{\year}}, height=5.6cm, width=7.0cm, clip=false]
	\fill[color=black!10] (axis cs:{2007-12-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
		(axis cs:{2009-07-01}, \pgfkeysvalueof{/pgfplots/ymax});
	\stdline{blue!80!black}{date}{RESPPMA_N.WW}{data/fed_assets.csv}
	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: Federal Reserve} \hspace{26mm} \tbllink{fed_assets.csv}\\
