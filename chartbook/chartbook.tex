...
With the private sector, households were net lenders of the equivalent of X.X percent of GDP in 2019 QX, while the net financial balance of private businesses--corporate and noncorporate--was virtually unchanged.\\
...
\footnotesize{\textit{age 25+ population, in millions, November 2019}}\\

\vspace{-1mm}
\noindent \hspace*{-4mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{2.5cm}{1.5ex}
    	width=5.3cm, bar width=3.0ex, height=5.6cm,
...
\noindent \normalsize \textbf{Education Distribution} \small \hspace{10mm} \cbox{red!70!purple} November 2019 \hspace{4mm} \cbox{orange!80} 2000\\
...
\small Some more personal income descriptive text here. Perhaps mention the total amount for real personal income and the share from labor, capital, and welfare in 1989, 2000, and 2019. Otherwise, at least mention the main three sources and how they contribute to change in personal income in the latest data.\\

\vspace{4mm}

\normalsize

Much more depth needed on income of households! This is probably the most important section in the document.\\
...
\small The increase in assets as a share of GDP also means that the return on total household assets has fallen, as measured by disposable income as a share of household assets. As of 2019 Q2, disposable income was equivalent to X.X percent of total assets. \\ 
...
\begin{minipage}{0.76\textwidth}
\small
The Census Bureau reports 41.2 million people in poverty in the US in 2018, more than the total population of Canada. For purposes of program eligibility and economic data, poverty is defined by having income below a certain threshold. The processes for calculating the threshold vary, with the official measure being based on roughly three times a typical food budget, and the supplemental measure additionally capturing program benefits and taxes.\\

Include data on number of people in poverty and the official poverty rate. Perhaps include a chart showing the official poverty rate over time. Perhaps also try to capture some concepts around methodology (SPM for example) and about relative poverty. What is the official poverty line and the line from the SPM?
...
\small Because the poverty line is less than a full-year of minimum wage work, a single person who works a full year at minimum wage will not officially be in poverty. If anything prevents them from working a full year, they will officially be in poverty. If they manage to work full-year but face a large expense, or live in a place with a high cost of living, they will be in poverty, but unofficially. The income from selling labor or from owning things is called market income. Because the US has a much smaller welfare system than any comparable country, market income is critical to avoiding poverty.\\

\small Market income without various government programs would have resulted in an additional 42.8 million people in poverty in 2018. Social security alone reduced poverty by 27.2 million people. 
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{2.0cm}{1.5ex}
    	width=5.0cm, bar width=1.7ex, height=7.8cm, xmin=0.5,
    	enlarge y limits={abs=0.3cm}, enlarge x limits=0.1, \bbar{x}{0},
		yticklabels from table={\poor}{name}, 
		yticklabel style={font=\footnotesize},
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=1, assume math mode},
		legend style={at={(0.5, 1.1)}}]
  	\addplot[fill=red!60!magenta, draw=none] 
  		table [y expr=-\coordindex, x index=1] {\poor};
  	\addplot[fill=violet, draw=none] 
  		table [y expr=-\coordindex, x index=2] {\poor};
  	\legend{SPM, OPM};
  	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: CPS ASEC} \hspace{28mm} \tbllink{poor.csv}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
  	...
  	\end{axis}
\end{tikzpicture}\\
\footnotesize{Source: CPS ASEC} \hspace{28mm} \tbllink{poor2.csv}
\end{minipage}
...
\small The national accounts include detailed information on aggregate corporate profits, which are an important determinant in the business cycle. In 2019 QX, aggregate corporate profits were XXXX billion, or X.X percent of net national income. Of this, XX billion, equivalent to X.X percent of net national product, were paid out as dividends (see\cbox{blue!70!purple}), XX billion were retained (see\cbox{cyan!50!white}), and XX billion went to corporate income tax (see\cbox{red!80!orange}).  \\
...
\noindent \normalsize \textbf{Labor Force Status Change}\\
\footnotesize{\textit{percentage point contribution to one-year growth, age 15+ population}}\\
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-2, 0, 2},
...
\footnotesize{\textit{November 2019, thousands of people, not seasonally adjusted}}\\
...
\footnotesize{\textit{Change from November 2018 to November 2019, thousands of people, not seasonally adjusted}}\\
...
\small In 2018, X.X percent of commuter zones have at least a third of their population working full-time and full-year. A total of X commuter zones, covering X million people in total, have a quarter of the population or less fully employed. Of commuter zones with 100,000 people or more, the top and bottom ten by fully-employed share of population are listed below.
\end{minipage}
...
\footnotesize{\textit{full-time, full-year worker share of population, 2018}}\\
...
\noindent \normalsize \textbf{Employment Rates} \small \hspace{10mm} \cbox{blue} November 2019 \hspace{4mm} \cbox{cyan!50} 2000\\
...
\noindent \normalsize \textbf{Occupational Employment, November 2019}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={}, width=10.0cm,
		xticklabel={`\short{\year}}, 
		extra x ticks={2019-10-01},
		extra x tick labels={0ct}, clip=false, 
...
\small Over the year ending November 2019, nominal wages increased by X.X percent for all employees and X.X for production and non-supervisory workers. The average wage over the past three months is X.X higher than over the previous three months for all employees and X.X percent for production and non-supervisory.\\
...
\small By industry, X of X groups experienced real wage growth (wage growth above the increase in prices indicated by the consumer price index). The mining \& logging industry had the fastest growth rate, at X.X percent, followed by X.X percent in information and X.X percent in professional and business services.  \\
...
Gabriel Mathy, Iordan Koulov, Lara Merling, Kevin Cashman, Rebecca Watts, Dean Baker, Eileen Appelbaum, John Schmitt, Yevgeniya Korniyenko, Magali Pinat, Rainer K\"ohler, Gersenda Varisco, Venkat Josyula, Tom Augspurger, Mike Sieferling, Matt Bruenig, Ernie Tedeschi, Ryan Bonkosky, and Vikas Sharma.
