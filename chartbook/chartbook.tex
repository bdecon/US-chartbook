...
%As an \href{https://www.bea.gov/help/faq/80}{example}, \input{text/gdp_contr_example.txt}
\end{minipage}
\vspace{1mm}
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15}, 
		...
		legend style={at={(0.72, 1.01)}, legend columns=-1}, yticklabel style={text width=1.0em},
		legend cell align={left}]
	\rbars
