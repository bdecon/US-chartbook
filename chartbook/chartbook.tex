...
\hypertarget{oegr}{}
\small Economists are concerned with changes in economic activity. This subsection discusses economic growth and identifies contributions from the major categories of activities discussed in the previous subsection.
...
\subsubsection*{Notes on economic growth}
...
\subsubsection*{A note on annualized rates}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100, 125, 150, 175}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=6.8cm, width=12.2cm]
	\rbars
...
\subsection*{Demographics and Household Formation}
\vspace{-1.0mm}

\small The Census Bureau provides \href{https://www.census.gov/programs-surveys/popest.html}{estimates} and \href{https://www.census.gov/programs-surveys/popproj.html}{projections} of the US population. Population levels and growth rates affect the economy and are critical pieces of information in determining and evaluating economic policies and outcomes. Population projections are based on assumptions, for example about the future level of net migration to the US, but are useful for thinking about future US demographics.
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks xmin=1990-01-01, xmax=2027-07-01,
		...
		height=5.8cm, width=12.8cm, yticklabel style={text width=1.6em}]
	\rbars
	...
	\absnode{{1993-01-01}}{280}{\small \color{violet}\textbf{Total}}
...
\footnotesize{\textit{people age 16 or older, percent}}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15, 20, 25, 30}, 
		yticklabel style={text width=1.0em}, 
		xticklabel={`\short{\year}}, clip=false, height=6.8cm, width=12.3cm]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30}, enlarge y limits={0.01},
		...
		xticklabel={`\short{\year}}, height=5.8cm, width=12.3cm, clip=false]
	\rbars
...
\hspace{4mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 100, 200, 300, 400, 500},
		 ymin=20, height=6.0cm, reverse legend, 	
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10, 15, 20, 25}, 
		height=6.6cm, enlarge y limits={0.02}, 
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-15, -10, -5, 0, 5, 10, 15, 20, 25},
		height=6.6cm, xticklabel={`\short{\year}}, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-30, -20, -10, 0, 10, 20, 30}, 
		yticklabel style={text width=1.5em}, height=7.2cm, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100}, ymin=2, 
		yticklabel style={text width=1.0em}, height=5.6cm,
...
\hspace*{-4mm} \begin{tikzpicture}
	\begin{axis}[\dateaxisticks ymin=118, enlarge x limits={0.01},
		width=8.5cm, height=7.0cm, ytick={0, 1000, 2000, 3000, 4000, 5000},
...
\newpage
\begin{minipage}{0.76\textwidth}
\subsubsection*{Government Spending and Investment}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-8, -6, -4, -2, 0, 2, 4}, 
		...
		height=5.8cm, enlarge y limits={0.01}, 
		xticklabel={`\short{\year}}, clip=false, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30, 40}, ymin=1,
		yticklabel style={text width=1.0em}, height=6.2cm, 
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[clip=false, stack negative=separate, ymajorgrids=false,
            ...
            width=5.6cm, height=11.0cm, legend style={legend columns=3, anchor=west, 
            at={(0, 1.05)}},
            \barylab{0.5cm}{1.0ex}]
	\addplot[xbar stacked, bar shift=0pt, fill=black!3!white, draw=none] 
		table [y expr=-\coordindex, x index=1] {\paepop};
	\addplot[xbar stacked, bar shift=0pt, fill=cyan!65!blue!22!white, draw=cyan!65!blue!22!white] 
		table [y expr=-\coordindex, x index=2] {\paepop};	
	\addplot[xbar stacked, bar shift=0pt, fill=blue!78!violet, draw=blue!78!violet] 
		table [y expr=-\coordindex, x index=3] {\paepop};
	\addplot[xbar stacked, bar shift=0pt, fill=cyan!65!blue!22!white, draw=cyan!65!blue!22!white] 
		table [y expr=-\coordindex, x index=4] {\paepop};
	\addplot[xbar stacked, bar shift=0pt, fill=black!3!white, draw=none] 
		table [y expr=-\coordindex, x index=5] {\paepop};	        
	\addplot[only marks, mark=diamond*, mark options={fill=orange!45!yellow, 
		draw=orange!45!yellow, scale=1.6}] 
...
\begin{tikzpicture}
	...
	\addplot [nodes near coords={\pgfmathprintnumber{\pgfkeysvalueof{/data point/x}}}, only marks, mark=none] table[y=y, x index=6] {\paepoptt};
	\end{axis}
\end{tikzpicture}\end{minipage}
\vspace{1mm}

\footnotesize{Source: Author's Calculations from CPS} \hfill \tbllink{state_pa_epop_full.csv}
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks width=6.2cm, height=8.8cm,
		minor xtick={}, xmin={2018-12-15}, yticklabel style={text width=2.0em},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 1, 2, 3, 4, 5}, 
		...
		xticklabel={`\short{\year}}, height=6.0cm, width=6.2cm, clip=false]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 10, 20, 30, 40, 50}, 
		...
		yticklabel style={text width=1.0em},
		xticklabel={`\short{\year}}, height=6.2cm, clip=false]
	\rbars
	\stdline{orange}{date}{Mean}{data/unempdur.csv}
	\stdline{green!75!blue}{date}{Median}{data/unempdur.csv}
	\absnode{{2016-01-01}}{15}{\color{green!75!blue}Median}
	\absnode{{2014-04-01}}{39}{\color{orange}Average}
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-3mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{1.8cm}{1.5ex}
    	width=5.2cm, bar width=1.8ex, height=5.6cm,
    	enlarge y limits={abs=0.3cm}, enlarge x limits=0.05, \bbar{x}{0},
		yticklabels from table={\nilf}{name}, xmin=0, 
		yticklabel style={font=\footnotesize}, nodes near coords, 
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=1, assume math mode},
		legend style={text=black!70, at={(0.28, 1.14)}, anchor=north, legend columns=-1, 
				fill=none, draw=none,
		        /tikz/every even column/.append style={column sep=0.4cm}}]
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={}, width=7.4cm, height=8.4cm,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks 
        ...
        legend cell align={left},
		legend style={fill=white, at={(0.44, 0.99)}}]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={6, 8}, clip=false,
		xticklabel={`\short{\year}}, height=6.6cm, width=7.0cm]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 0.5, 1.0, 1.5, 2.0}, 
		...
		ymin=0.08, ymax=1.9,
		xticklabel={`\short{\year}}, height=5.8cm, width=12.4cm, clip=false]
	\rebars
...
The current population survey asks whether individuals have the same employer as they did the previous month. The rate at which people say they have changed employers had fallen to below two percent after the great recession, from an average of around three percent during the late 1990s. 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={1.5, 2, 2.5, 3, 3.5, 4}, 
		enlarge y limits={0.05}, clip=false, 
		xticklabel={`\short{\year}}, height=6.0cm, width=12.5cm]
	\rebars
	\thinline{orange}{date}{Monthly}{data/jobswitch.csv}
	\stdline{blue}{date}{MA3}{data/jobswitch.csv}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\shdateaxisticks ytick={4, 5, 6}, 
		enlarge y limits={0.05}, clip=false,
		xticklabel={`\short{\year}}, height=4.4cm, width=7.8cm]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 2, 4, 6, 8}, 
		...
		legend columns=1, legend cell align={left}, height=6.6cm, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\barplotnogrid axis y line=left, 
		...
		height=9.2cm, xtick={0}, xmajorgrids,
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={8, 10, 12, 14, 16, 18}, 
		yticklabel style={text width=1.0em}, 
		enlarge y limits={0.1}, 
		xticklabel={`\short{\year}}, height=5.2cm, width=12.2cm, clip=false]
	\rebars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 5, 10, 15, 20}, ymin=1,
		height=6.5cm, width=12.6cm, enlarge y limits={0.11},
		yticklabel style={text width=1.0em}, 
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-5, 0, 5, 10, 15}, 
		yticklabel style={text width=1.0em}, 
		xticklabel={`\short{\year}}, clip=false, 
		height=6.2cm, enlarge y limits={0.11}, legend style={at={(0.96, 1.05)}, fill=white}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\absnode{{2004-03-01}}{1.6}{\scriptsize \color{blue}\textbf{Two-year}}
	\absnode{{2014-05-01}}{3.5}{\scriptsize \color{red!90}\textbf{Ten-year}}
	\end{axis}
\end{tikzpicture}\\
...
\noindent \hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-2, 0, 2, 4, 6, 8}, 
		...
		height=6.2cm, width=12.4cm, enlarge y limits={0.12}]
	\rbars
...
\begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{2cm}{1.5ex}
    	width=6.0cm, bar width=1.9ex, height=8.4cm,
    	enlarge y limits={abs=0.35cm}, enlarge x limits=0.25, \bbar{x}{0},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \tydateaxisticks ytick={-4, -2, 0, 2, 4, 6, 8}, 
		height=6.8cm, width=12.9cm, enlarge x limits={0.01}, 
		yticklabel style={text width=1.2em},
        xticklabel={`\short{\year}}, legend cell align={left},
		legend style={legend columns=2, at={(0.43, 0.96)}}]
	\rbars
...
\begin{minipage}{0.76\textwidth}
\subsubsection*{Why Isn't the CPI Revised?}
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\dateaxisticks ytick={-20, -10,  0, 10, 20}, 
		...
		yticklabel style={text width=1.6em},
		xticklabel={`\short{\year}}, height=6.2cm, width=12.0cm]
    	\rbars
