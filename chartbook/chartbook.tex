...
%
	...
	% very thin stacked diverging bar
	\newcommand{\vtsbar}[4]{
		\addplot[ybar stacked, bar width=1.9pt, draw opacity=0, fill=#1] 
			table [x=#2, y=#3, col sep=comma]{#4};}
			
	% extra thin stacked diverging bar
	\newcommand{\etsbar}[4]{
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-2, -1, 0, 1, 2},
		xticklabel={`\short{\year}}, clip=false, 
		legend style={at={(0.95, 1.13)}, fill=white}]
	\rbars
...
\begin{minipage}{0.34\textwidth}
\small This section looks at \textbf{income received by people}, by type of income, adjusted for inflation using the PCE implicit price deflator. Income is divided into labor income (see\cbox{green!80!black}), which is measured as compensation of employees, capital income (see\cbox{orange!50!yellow}), measured as the sum of proprietor income, rental income, and dividend and interest income, and welfare income  (see\cbox{blue!80!white}), which is measured as transfers to persons, primarily government social benefits, less contributions to social insurance. \\
...
\noindent \hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60},
		...
		legend style={at={(0.85, 1.08)}}, width=7.1cm, height=7.6cm]
	\rbars
	\etsbar{green!80!black}{date}{LABOR}{data/pi_levels.csv}
	\etsbar{blue!80!white}{date}{TRANSFER}{data/pi_levels.csv}
	\etsbar{orange!50!yellow}{date}{CAPITAL}{data/pi_levels.csv}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-20, -15, -10, -5, 0, 5}, 
		...
		xticklabel={`\short{\year}}, clip=false, height=5.0cm, width=12.6cm]
	\rbars
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\fill[color=black!10] (axis cs:{2007-12-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
		(axis cs:{2009-07-01}, \pgfkeysvalueof{/pgfplots/ymax});
	\vtsbar{blue!50!violet}{date}{Midwest_Q}{data/val_ooh.csv}	
	\vtsbar{lime!70!green!80!white}{date}{Midwest_P}{data/val_ooh.csv}
...
\begin{tikzpicture}
	...
	\fill[color=black!10] (axis cs:{2007-12-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
		(axis cs:{2009-07-01}, \pgfkeysvalueof{/pgfplots/ymax});
	\vtsbar{blue!50!violet}{date}{Northeast_Q}{data/val_ooh.csv}	
	\vtsbar{lime!70!green!80!white}{date}{Northeast_P}{data/val_ooh.csv}	
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\fill[color=black!10] (axis cs:{2007-12-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
		(axis cs:{2009-07-01}, \pgfkeysvalueof{/pgfplots/ymax});
	\vtsbar{blue!50!violet}{date}{West_Q}{data/val_ooh.csv}	
	\vtsbar{lime!70!green!80!white}{date}{West_P}{data/val_ooh.csv}
...
\begin{tikzpicture}
	...
	\fill[color=black!10] (axis cs:{2007-12-01},\pgfkeysvalueof{/pgfplots/ymin}) rectangle 
		(axis cs:{2009-07-01}, \pgfkeysvalueof{/pgfplots/ymax});
	\vtsbar{blue!50!violet}{date}{South_Q}{data/val_ooh.csv}	
	\vtsbar{lime!70!green!80!white}{date}{South_P}{data/val_ooh.csv}	
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{7.8cm}{2.3cm}{\scriptsize \color{blue!80!black}\textbf{Total index}}
	\end{axis}
\end{tikzpicture}\\
...
\noindent \hspace*{-3mm} \begin{tikzpicture}
	...
	\rbars
	\etsbar{green!50!teal!85!blue}{date}{Employed}{data/cps_lfs.csv}
	\etsbar{lime!80!yellow!90!white}{date}{Unemployed}{data/cps_lfs.csv}
	\etsbar{blue!80!cyan}{date}{NILF}{data/cps_lfs.csv}
	\etsbar{cyan!80!white}{date}{Children}{data/cps_lfs.csv}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\tkbar{green!50!teal!85!blue}{date}{Employed}{data/cps_lfs2.csv}
	\tkbar{lime!80!yellow!90!white}{date}{Unemployed}{data/cps_lfs2.csv}
	\tkbar{blue!80!cyan}{date}{NILF}{data/cps_lfs2.csv}
...
\small The \href{https://www.bls.gov/ces/}{establishment survey} from the monthly jobs report identifies how many jobs have been added to the economy in a given month (see\cbox{blue!60!purple}). \input{text/nfp_basic_text.txt}
\end{minipage} \hspace{6mm}
\begin{minipage}{0.39\textwidth}
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks width=7.2cm, height=5.6cm,
		xtick={{2014-01-01}, {2016-01-01}, {2018-01-01}, {2020-01-01}},
		minor xtick={}, xmin={2013-11-01}, yticklabel style={text width=2.4em},
...
\noindent \hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 2, 4, 6, 8, 10, 12, 14, 16}, 
		height=5.8cm, ymin=0.3, legend cell align={left},
		xticklabel={`\short{\year}}, clip=false, 
		legend style={fill=white, legend columns=2, at={(0.48, 1.0)}}]
	\rbars
	\addplot[stack plots=y, area style, draw=none, fill=blue!60!purple] 
		table [x=date, y=Job Loser, 
		col sep=comma]{data/unemp_reason.csv}\closedcycle;	
	\addplot[stack plots=y, area style, draw=none, fill=yellow] 
		table [x=date, y=Job Leaver, 
		col sep=comma]{data/unemp_reason.csv}\closedcycle;
	\addplot[stack plots=y, area style, draw=none, fill=orange!80!yellow] 
		table [x=date, y=Re-entrant, 
		col sep=comma]{data/unemp_reason.csv}\closedcycle;
	\addplot[stack plots=y, area style, draw=none, fill=red] 
		table [x=date, y=New entrant, 
		col sep=comma]{data/unemp_reason.csv}\closedcycle;
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\stdline{cyan!85!blue}{date}{weekly}{data/icsa.csv}
	\end{axis}
\end{tikzpicture}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \ltdateaxisticks ytick={0, 5000, 10000, 15000, 20000}, 
		...
		xticklabel={`\short{\year}}, height=6.6cm, width=6.2cm]
	\rbars
	\stdline{green!70!blue}{date}{weekly}{data/ccsa.csv}
	\end{axis}
\end{tikzpicture}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 2, 4, 6, 8, 10, 12}, 
		...
		xticklabel={`\short{\year}}, height=5.2cm, width=8.0cm]
	\rbars
	...
	\stdnode{3.3cm}{1.45cm}{\scriptsize \color{cyan}\textbf{Hires}}
	\stdnode{5.0cm}{2.1cm}{\scriptsize \color{blue!80!black}\textbf{Openings}}
	\stdnode{4.9cm}{1.1cm}{\scriptsize \color{red!85!violet}\textbf{Quits}}
	\stdnode{1.5cm}{0.35cm}{\scriptsize \color{orange!70!yellow}\textbf{Layoffs}}
	\end{axis}
\end{tikzpicture}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rbars
	\vtsbar{violet}{date}{Membership}{data/union.csv}	
	\vtsbar{magenta!70!purple}{date}{Diff}{data/union.csv}	
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 2, 4, 6, 8, 10}, 
		xticklabel={`\short{\year}}, clip=false, ymin=0.5, width=7.5cm]
	\rbars
...
\noindent \hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={-2, 0, 2, 4, 6}, 
		xticklabel={`\short{\year}}, clip=false, width=8.6cm,
		legend style={at={(1.0, 1.11)}, fill=white},
		height=4.0cm, enlarge y limits={0.11}]
	\rbars
...
\footnotesize{Source: Bureau of Economic Analysis} \hspace{24mm} \tbllink{pce_pi.csv}
