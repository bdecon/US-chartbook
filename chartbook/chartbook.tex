...
\small It's useful to consider household inputs when measuring economic output. For example, is the population growing? Are more people working? Are people working more hours? Is the economy more productive in its use of labor? These questions all add import context to discussion of aggregate ouput.\\
