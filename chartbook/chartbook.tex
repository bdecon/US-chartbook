...
\noindent \hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 10, 20, 30, 40, 50, 60},
		...
		legend style={at={(0.95, 1.08)}}, width=7.3cm, height=7.6cm]
	\rbars
	...
	\legend{Labor, Welfare$^2$, Capital$^1$};
	\stdnode{2.7cm}{1.1cm}{\scriptsize $^1$ Includes proprietor, rent, and asset income\\ \scriptsize $^2$ Current transfer receipts minus contributions\\\scriptsize \ \ \ \ to government social insurance}
	\end{axis}
\end{tikzpicture}\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\dateaxisticks ymin=0.8, enlarge x limits={0.01},
