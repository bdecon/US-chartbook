...
\small The recent slowdown has been broad-based. The monthly data are shown in detail below.\\
...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{7.8cm}{2.2cm}{\scriptsize \color{blue!80!black}\textbf{Total index}}
	\end{axis}
\end{tikzpicture}\\
