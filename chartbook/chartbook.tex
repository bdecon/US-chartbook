...
{\color{gray} \faGithub} \ \ \color{black}\href{https://github.com/bdecon/US-chartbook}{bdecon/US-chartbook}
\end{minipage}
\thispagestyle{empty}
...
\item {\seriffont \hyperref[sec:ov]{Overview}}
...
\small While the ratio of public debt to GDP is fairly stable, and the interest income from holding public debt is lower than in the past because of lower interest rates, Treasuries and other government debt securities provide a stable asset for the balance sheets domestic households and businesses, and for foreign investors. \\
