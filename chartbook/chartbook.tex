...
\noindent \hspace*{-2mm} \begin{tikzpicture}
	...
	\rebars
	\stdnode{3.7cm}{1.2cm}{\footnotesize \color{orange!80!white}Government}
	...
	\stdnode{1.5cm}{1.9cm}{\footnotesize \color{red!90!white}FIRE+}
...
\small \textbf{Total liabilities} are the sum of debts and other financial obligations at a point in time. While the vast majority of US borrowing comes from US lending, meaning the net result on US balance sheets is zero, it is still useful to consider how total liabilities vary by major sector and over time. 

\input{text/liabsh.txt}
\vspace{1mm}

\normalsize \textbf{Total Liabilities by Sector}\\
\footnotesize{\textit{share of GDP, percent}}\\
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={0, 25, 50, 75, 100, 125, 150, 175}, 
		yticklabel style={text width=1.4em}, ymin=9,
		xticklabel={`\short{\year}}, clip=false, height=6.4cm, width=12.2cm]
	\rbars
	\thickline{blue!70!white}{date}{FL314190005.Q}{data/liabsh.csv}
	\absnode{{2014-05-01}}{113}{\footnotesize \color{blue}Federal Gov.}
	\thickline{cyan!60!white}{date}{FL214190005.Q}{data/liabsh.csv}
	\absnode{{2011-05-01}}{39}{\footnotesize \color{cyan}State \& Local Gov.}
	\thickline{orange!90!red}{date}{FL154190005.Q}{data/liabsh.csv}
	\absnode{{2014-10-01}}{75}{\footnotesize \color{orange!90!red}Household}
	\thickline{green!72!black}{date}{Business}{data/liabsh.csv}
	\absnode{{1991-10-01}}{116}{\footnotesize \color{green!72!black}Private Business}
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks ytick={-2, 0, 2, 4, 6, 8, 10}, 
		xmin = 1989-01-01, height=6.5cm, width=13.0cm, enlarge y limits={0.05}, 
		xticklabel={`\short{\year}}, yticklabel style={text width=1.0em}, clip=false, 
		legend style={at={(0.95, 1.12)}}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \dateaxisticks xmin=1990-01-01, xmax=2027-07-01,
		...
		height=6.2cm, width=12.8cm, yticklabel style={text width=1.6em}]
	\rbars
...
\hspace*{-2mm} \begin{tikzpicture}
  	\begin{axis}[ybar=16pt, \bbar{y}{0}, ytick={0, 20, 40, 60, 80, 100}, 
		...
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
			precision=1, assume math mode}, legend cell align={left},
		legend style={at={(0.21, 1.06)}, legend columns=1, 
		fill=white, draw=none}]
...
\begin{minipage}{0.3\textwidth}
\small \textbf{Personal income} \href{https://www.bea.gov/data/income-saving/personal-income}{includes} labor income (see\cbox{green!75!black}), measured as compensation of employees, capital income (see\cbox{orange!40!yellow}), measured as the sum of proprietor income, rental income, and dividend and interest income, and welfare income (see\cbox{blue!80!white}), measured primarily as government social benefits less contributions to social insurance. 
...
\footnotesize{\textit{income amounts in \input{text/pinc_year1.txt}USD}}\\
...
\footnotesize{\textit{per capita, thousands of \input{text/gdp_ltdt.txt}dollars}}\\
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 2, 4, 6, 8, 10}, ymin=0.6, 
		yticklabel style={text width=1.0em},
...
\footnotesize{\textit{per capita, thousands of \input{text/gdp_ltdt.txt}dollars}}\\
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks ytick={0, 5, 10, 15, 20, 25}, ymin=1.5, 
		yticklabel style={text width=1.0em},
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\stdnode{4.3cm}{0.4cm}{\footnotesize \color{red!20!orange!95!black}Black}
	\stdnode{4.4cm}{6.6cm}{\footnotesize \color{blue!80!cyan!80!black}White}
...
\begin{tikzpicture}
	...
	\abar{green!65!blue}{date}{Wind}{data/elec_prod.csv}vv
...
\hspace*{-2mm} \begin{tikzpicture}
	...
	\legend{Assets, Liabilites, Equity, Statistical Discrepancy, Total};
	\end{axis}
\end{tikzpicture}\\
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks 
		...
		yticklabel style={text width=1.3em},
		xticklabel={`\short{\year}}, height=6.6cm, width=6.4cm]
	\rbar
	...
	\absnode{{2017-01-01}}{190}{\footnotesize \color{green!80!blue}Exports}
	\absnode{{2016-01-01}}{265}{\footnotesize \color{blue!80!violet}Imports}
	\end{axis}
\end{tikzpicture}
\vspace{0.1mm}
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\ltdateaxisticks 
		...
		xticklabel={`\short{\year}}, height=5.6cm, width=6.4cm]
	\rbar
...
\footnotesize{\textit{includes goods and services, but excludes petroleum products, share of GDP}}\vspace{3.4cm}
...
\hspace{4mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks max space between ticks=20,	 
		yticklabel style={text width=1.4em},
		height=8.0cm, ymax=7.75, enlarge y limits={0.02},
		xticklabel={`\short{\year}}, clip=false, 
		legend style={at={(0.91, 0.97)}, fill=white}]
	\rbars
...
\newpage
\begin{minipage}{0.76\textwidth} 
\small Employment rates vary over time, but also by age, gender, and education. Over the three months ending \input{text/cps_lfs_date.txt}\unskip, the employment rate for most age and education subgroups is lower than it was before the pandemic (the three months ending \input{text/cps_lfs_dateprepan.txt}\unskip).
\vspace{1mm}
...
\hspace*{-4mm} \begin{tikzpicture}
  	\begin{axis}[\barplotnogrid axis y line=left, \barylab{1.0cm}{1.5ex}
    	width=6.1cm, bar width=1.6ex, height=5.6cm,
    	enlarge y limits={abs=0.35cm}, enlarge x limits=0.05, \bbar{x}{0},
...
\hspace*{-2mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, \shdateaxisticks clip=false,
		enlarge y limits={0.18}, ymin=1.2,
...
\normalsize \textbf{Recent Changes}\\
\footnotesize{\textit{percentage points}}
\vspace{4.1cm}

\hspace{3mm} \begin{tikzpicture}[overlay]
	\begin{groupplot}[group style={group size=2 by 1, horizontal sep=62pt}]
	\nextgroupplot[\bbar{y}{0}, width=5.6cm, height=5.6cm, 
		...
		xticklabel style={black!90, font=\small, text width=1.5cm, align=center}, 
	 	enlarge x limits={0.1}, transpose legend,
	 	reverse legend,
	 	xticklabels from table={\rych}{name}, enlarge y limits={lower, 0.3},
  	...
  	\addplot[opacity=0] coordinates {(1, 0)};
	\addplot[ybar stacked, bar width=20pt, draw opacity=0, fill=black!12!white] table [x expr=\coordindex, y=IE]{\rych};
	\addplot[ybar stacked, bar width=20pt, draw opacity=0, fill=lime!50!green!80!black] table [x expr=\coordindex, y=RY]{\rych};
	\stdnode{1.6cm}{3.6cm}{\normalsize \color{black!90} \textbf{Three-month change}}
	\input{text/inf_exp_ch_nodes.txt}
	\nextgroupplot[\bbar{y}{0}, width=5.6cm, height=5.6cm, 
		axis line style={draw=none}, xtick=data, clip=false, ytick={0}, 
		xticklabel style={black!90, font=\small, text width=1.5cm, align=center}, 
	 	enlarge x limits={0.1}, transpose legend, reverse legend,
	 	xticklabels from table={\rytch}{name}, enlarge y limits={lower, 0.12},
	 	nodes near coords style={style={black!75, anchor=south,
		 yshift=1.5mm, inner sep=0.5}, /pgf/number format/.cd, fixed zerofill,
			precision=2, assume math mode}, legend cell align={left}, 
		legend style={legend columns=-1, at={(0.68, 1.34)}}]
  	\addplot[scatter, mark=*, only marks, mark options={fill=blue, 
		draw=blue, scale=1.5}, nodes near coords] 
  		table [x expr=\coordindex, y=Total] {\rytch};
	\addplot[ybar stacked, bar width=20pt, draw opacity=0, fill=black!12!white] table [x expr=\coordindex, y=IE]{\rytch};
  	\addplot[opacity=0] coordinates {(1, 0)};
	\addplot[ybar stacked, bar width=20pt, draw opacity=0, fill=lime!50!green!80!black] table [x expr=\coordindex, y=RY]{\rytch};
	\stdnode{1.6cm}{4.0cm}{\normalsize \color{black!90} \textbf{Three-year change}}
...
\small In effect, the 12-month percent change in prices is smoothed, relative to the one-month change in prices, by including information on price changes that happened over the past year. While the chartbook uses less-volatile 12-month inflation rates in most cases, the \textbf{one-month rate} can be more useful for examining short-term trends, for example by eliminating the base effects from changes in prices a year ago. 
...
\hspace*{-3mm} \begin{tikzpicture}
	\begin{axis}[\bbar{y}{0}, date coordinates in=x, axis line style={draw=none},
		...
		yticklabel style={text width=1.0em}, ymax=16, ymin=-4, 
		nodes near coords,
		nodes near coords style={/pgf/number format/.cd, fixed zerofill,
...
\hspace{2mm} \begin{tikzpicture}[overlay]
	\begin{axis}[\bbar{y}{0}, \dateaxisticks 
		enlarge y limits={0.25}, max space between ticks=20,	
		yticklabel style={text width=1.2em}, width=12.2cm, height=4.6cm, ymin=0.9,
		xticklabel={`\short{\year}}, clip=false]
	\rebars
