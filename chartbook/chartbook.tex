...
\small Economists are concerned with changes in production. Decreased production can result in material hardship for ordinary people. This chartbook section covers changes in production measured as the rate of growth of overall economic activity, and also describes how major categories of activities contribute to overall growth.\\
...
Price-adjusted or real GDP is adjusted for changes in quality. This means that real GDP can increase even if the quantity produced does not change. Distribution,  productivity, and prices are discussed in later sections.
